# 🔄 Guia de Versionamento — Gestão 2027 + GitHub
...
```
GitHub: github.com/valdosouza/

├── gestao-2027-setes-api         (Node.js + TypeScript)
│   ├── src/
│   ├── dist/
│   ├── package.json
│   ├── tsconfig.json
│   └── .gitignore
│
├── gestao-2027-setes-sync        (Node.js + TypeScript)
│   ├── src/
│   ├── dist/
│   ├── package.json
│   ├── tsconfig.json
│   └── .gitignore
│
├── gestao-2027-sincronizador     (Delphi Legado)
│   ├── source/
│   ├── exe/
│   ├── lib/
│   └── .gitignore
│
├── gestao-2027-infra-ia          (Documentação + Agentes + Skills)
│   ├── docs/
│   ├── agents/
│   ├── skills/
│   └── .gitignore
│
└── gestao-2027-codigo-aprendizado (Modelos Delphi para referência)
    ├── model/
    ├── dataobjects/
    └── .gitignore
```
...
```bash
git config --global user.name "Valdo Souza"
git config --global user.email "valdo@setes.com.br"
...
ssh-keygen -t ed25519 -C "valdo@setes.com.br"
...
git remote add origin https://github.com/valdosouza/gestao-2027-setes-api.git
...
# 5. Primeiro commit
git add .
git commit -m "Initial commit: Setup setes-api"
...
- [ ] setes-api inicializado e pushado
- [ ] setes-sync inicializado e pushado
- [ ] sincronizador inicializado e pushado
- [ ] infra-ia inicializado e pushado
- [ ] codigo-aprendizado inicializado e pushado
...
Quero versionas setes-api no GitHub
```
