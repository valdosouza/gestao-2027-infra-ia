...
git config user.name "Valdo Souza"
git config user.email "valdo@setes.com.br"
```
...
#    Nome: gestao-2027-setes-api (exemplo)
...
git remote -v
# Deve mostrar:
# origin  https://github.com/valdosouza/gestao-2027-setes-api.git (fetch)
# origin  https://github.com/valdosouza/gestao-2027-setes-api.git (push)
```
...
### setes-api / setes-sync (Node.js + TypeScript)
...
### Infra-IA / Documentação (Markdown)
...
- [ ] Repositório visível em github.com/valdosouza
...
*Agente responsável: Git/GitHub Specialist (a718badcc73c86bdf)*
