# 🔐 Resumo de Segurança — Git/GitHub <empresa>
...
```
1. <responsável> lê: SEGURANCA_GIT.md (15 min)
2. <responsável> ativa: Branch protection no GitHub (5 min)
3. <responsável> cria: GitHub Secrets para credenciais (10 min)
