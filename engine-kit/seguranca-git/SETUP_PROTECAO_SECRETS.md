...
bash scripts/limpar-secrets-git.sh https://github.com/<conta-github>/<repo-aprendizado>.git

# 3. Fazer push force (após validar!)
cd <repo-aprendizado>.git
git push --force
```
...
**Teste:**
```bash
# Criar arquivo sensível (use uma chave de exemplo no formato real)
echo "apiKey: <REMOVIDO>" > teste.txt
