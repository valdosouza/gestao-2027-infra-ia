unit Un_RL_ReportChequeRastrearDestino;
...
type
  TRL_ReportChequeRastrearDestino = class(TRL_ReportChequeRastrear)
...
var
  RL_ReportChequeRastrearDestino: TRL_ReportChequeRastrearDestino;

implementation

{$R *.dfm}

{ TRL_ReportChequeRastrearDestino }

procedure TRL_ReportChequeRastrearDestino.SelectSql;
begin
...
procedure TRL_ReportChequeRastrearDestino.WhereSql;
begin
  inherited;
  WhereTxt := WhereTxt + ' AND ((FIN_CODQTC IS NOT NULL) AND (FIN_CODQTC > 0)) ';
end;

procedure TRL_ReportChequeRastrearDestino.InnerJoinSql;
begin
  InnerJoinTxt := '   INNER JOIN TB_CHEQUES Tb_cheques '+
                  '   ON  (Tb_cheques.CHQ_QT_PAG = tb_financeiro.FIN_CODQTC) '+
...
procedure TRL_ReportChequeRastrearDestino.QrptBeforePrint(
...
procedure TRL_ReportChequeRastrearDestino.BuscarCheques;
begin
  With Qr_Cheque do
  Begin
    Close;
    ...
    sql.Add('SELECT CHQ_NR_BANCO, CHQ_AGENCIA,  CHQ_NUMERO, CHQ_EMITENTE, '+
            ...
            'WHERE (CHQ_QT_PAG=:CODQUITACAO) ');
    active := True;
  End;
end;

procedure TRL_ReportChequeRastrearDestino.BuscarFinanceiro;
begin
