...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Un_Base, Data.DB, Vcl.Grids, Vcl.DBGrids, Vcl.Buttons, Vcl.StdCtrls, Vcl.ExtCtrls, Datasnap.DBClient, Datasnap.Provider, STQuery, Vcl.Menus, Un_Msg;
...
uses     UN_Principal, env, RN_Permissao, Un_DM, Un_Regra_Negocio, Un_Sistema;
