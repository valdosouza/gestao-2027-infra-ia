...
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, tblItensicms, Generics.Collections, controllerProduto;
...
procedure TControllerItensICMS.deleteByNF;
Var
  Lc_Qry : TSTQuery;
Begin
  Lc_Qry := GeraQuery;
