...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, Un_sistema, Un_Regra_Negocio, tblCardapio, ControllerGrupos, Un_MSg, ControllerMedida, ControllerPreco, ControllerEstoque;
...
uses     RN_Estoque, RN_Produto, env;
...
begin
  ...
  Try
    ...
    Begin
      ...
      //Tabela 1 - normal
      ParamByName('PRC_VL_VDA').AsCurrency := PrecoNormal;
      ...
      //Tabela 1 - Promoção
      Active := False;
      ParamByName('PRC_VL_VDA').AsCurrency := PrecoPromocao;
      ParamByName('MED_CODIGO').AsInteger := Registro.MedidaComercial;
      ParamByName('SBG_CODIGO').AsInteger := Registro.CodigoSubgrupo;
  ...
  Try
    ...
    Begin
      sql.Add('UPDATE TB_PRODUTO SET '+
              ...
              'PRO_CODMED =:PRO_CODMED, '+
              'PRO_CODMED_TRIB =:PRO_CODMED_TRIB, '+
              'PRO_ATIVO =:PRO_ATIVO '+
      ...
      ParamByName('PRO_CODMED').AsInteger       := Registro.MedidaComercial;
      ParamByName('PRO_CODMED_TRIB').AsInteger  := Registro.MedidaTributavel;
      ParamByName('GRP_CODIGO').AsInteger       := Registro.CodigoGrupo;
      ParamByName('SBG_CODIGO').AsInteger       := Registro.CodigoSubgrupo;
      ExecSQL;
    End;
