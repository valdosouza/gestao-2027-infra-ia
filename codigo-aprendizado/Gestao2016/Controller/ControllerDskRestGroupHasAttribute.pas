...
interface
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblProduto, Un_MSg, ControllerMedida, Generics.Collections, controllerPreco, ControllerEmbalagem, controllerEstoques, ControllerMarcaProduto, ControllerGRupos, ControllerCtrlEstoque, ControllerTabelaPreco, tblRestMenuHasProduct, tblStockBalance, tblPrice, ObjStockList, ObjPriceList, System.StrUtils, Vcl.Forms;
 ...
 Lc_Upt := GeraQuery;
  Try
    ...
    Begin
      ...
      End;
      //Agora inicia do 1 para ajustar a orde�ção
      getList('');
      FProgresso.Progress := 0;
      FProgresso.MinValue := 0;
      FProgresso.MaxValue := Lista.Count;
...
begin
  ...
  Try
    ...
    Begin
      ...
      //Criei objeto contorller para produto e para menu cardapio  Aqui � igual a Automatico
