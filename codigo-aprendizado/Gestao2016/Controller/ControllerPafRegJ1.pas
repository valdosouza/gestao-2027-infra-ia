  ...
  Try
    ...
    Begin
      ...
      Begin
        ...
        LITem.ValorTotalLiquido   := FieldByname('nfl_vl_tl_nota').AsCurrency + FieldByname('ped_vl_desconto').AsCurrency;
        LITem.DescontoSubTotal    := FieldByname('ped_vl_desconto').AsCurrency;
        LITem.SubTotal            := FieldByname('nfl_vl_tl_nota').AsCurrency;
