...
uses     STDatabase, STQuery, Classes, SysUtils, ControllerBase, tblCotacao, Generics.Collections, ControllerItensCotacao, System.Math, Un_Msg, prm_quotation_log;
Type
  ...
  Try
    ...
    Begin
      ...
      TRy
        ...
        Begin
          ...
          while not eof do
          Begin
            Lc_VL_Cotacao := Lc_VL_Cotacao + (FieldByName('ICT_VL_UNIT').AsCurrency * FieldByName('ICT_QTDE').AsFloat);
            next;
          end;
          Lc_Upt.SQL.Clear;
          ...
          begin
            ...
            Lc_Vl_Subtotal := (FieldByName('ICT_VL_UNIT').AsCurrency * FieldByName('ICT_QTDE').AsFloat);
            ...
            //Avan�a para o proximo registro
            Next;
            ...
            Lc_Upt.ParamByName('ICT_VL_DESC').AsCurrency := Lc_Vl_Desconto;
            Lc_Upt.ExecSQL;
          end;
        end;
      Finally
    ...
    Begin
      ...
      Lc_SqlTxt := 'UPDATE TB_ITENS_CTC SET ' +
                    ...
                    'WHERE (ICT_CODPED=:ICT_CODPED) ';
      Lc_Upt.SQL.Add(Lc_SqlTxt);
      Lc_Upt.ParamByName('ICT_CODPED').AsInteger := PedidoID;
      Lc_Upt.ExecSQL;
    End;
  Finally
...
Begin
  ...
  Try
    ...
    Begin
      ...
      ParamByName('CTC_STATUS').AsString := 'A';
...
begin
  ...
  try
    ...
    Begin
      ...
      Active := True;
      Lc_Ordem := Copy( FieldByName('MAX').AsString, 7, 5);
...
begin
  ...
  Try
    ...
    Begin
      ...
      if Parametros.FieldName.Status <> EmptyStr then
      Begin
        SQL.Text := SQL.Text + ' AND (C.CTC_STATUS = :CTC_STATUS) ';
        ParamByName('CTC_STATUS').AsString := Parametros.FieldName.Status;
      End;
