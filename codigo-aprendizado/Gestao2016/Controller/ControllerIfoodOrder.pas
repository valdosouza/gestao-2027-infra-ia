...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblIfoodOrder, Un_MSg, Generics.Collections, ControllerIfoodDelivery, ControllerIfoodCustomer, ControllerIfoodOrderItems, ControllerIfoodOrderPayment, ControllerIfoodOrderTotal, ControllerIfoodEvents, ControllerIfoodOrderBenefits, ControllerClienteFromExterior, ControllerPedidoFromExterior;
...
begin
  ...
  FreeAndNil(Events);
  FreeAndNil(Benefits);
  FreeAndNil(ClienteFromExterior);
  inherited;
end;
