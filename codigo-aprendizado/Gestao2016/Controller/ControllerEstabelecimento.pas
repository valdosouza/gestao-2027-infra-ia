...
interface
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblempresa, ControllerEndereco, Vcl.Graphics, Vcl.Imaging.jpeg, Data.DB;
...
begin
  ...
  begin
    Lc_Qry := getByField('TB_EMPRESA','EMP_CNPJ',Registro.CpfCNPJ);
    try
      get(Lc_Qry, Registro);
    finally
