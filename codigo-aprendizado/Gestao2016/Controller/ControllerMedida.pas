...
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, tblMedida, Un_MSg, Generics.Collections, prm_measure;
...
Begin
  ...
  Try
    with Lc_Qry do
    Begin
      {Cuidado ao mexer nesta fun�ao, se colocar o get aqui dentro vai ter problema
      na alterção dos sabores - se precisar deste dos para validar coloque o get fora }
      exist := False;
      active := False;
      sql.Clear;
      SQL.Add('SELECT * '+
