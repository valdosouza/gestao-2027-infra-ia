...
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, tblInventario, Generics.Collections, ControllerProduto, ControllerCtrlEstoque, System.Variants;
    ...
    Begin
      ...
      ///SELECT DOS DOCUMENTOS FATURADOS E COM COMPOSIÇÃO
                   ...
                   '  AND ((NFL_STATUS <> ''C'') or (NFL_STATUS IS NULL)) ',
                    ' AND ( ITF_CODPRO =:PRO_CODIGO ) ',
                    ' and ( ITF_CODEST =:EST_CODIGO ) ',
      //SELECT DOS DOCUMENTOS N�O FATURADOS E SEM COMPOSIÇÃO
                    'union ',
                    'SELECT 0 CET_CODIGO, ',
                    '        1 CET_TERMINAL, ',
                    '        ''P'' CET_VINCULO, ',
                    ...
                    ' AND ( ITF_CODPRO =:PRO_CODIGO ) ',
                    ' and ( ITF_CODEST =:EST_CODIGO ) ',
      ///SELECT DOS DOCUMENTOS N�O FATURADOS E COM COMPOSIÇÃO
                    ' UNION ',
                    ' SELECT 0 CET_CODIGO, ',
                    '        1 CET_TERMINAL, ',
                    '        ''P'' CET_VINCULO, ',
