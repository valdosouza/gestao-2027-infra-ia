...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, Un_MSg, Generics.Collections, System.Math;
  ...
  Try
    ...
    Begin
      ...
      Begin
        ...
        LITem.ValorUnitario       := FieldByname('ITF_VL_UNIT').AsCurrency;
        LITem.DescontoItem        := FieldByname('ITF_VL_DESC').AsCurrency;
        LITem.AcrescimoItem       := 0;
        LITem.ValorLiquido        := FieldByName('ITF_VL_UNIT').AsCurrency * FieldByName('ITF_QTDE').AsFloat;
