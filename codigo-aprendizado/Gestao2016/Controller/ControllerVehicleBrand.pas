...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblVehicleBrand, Un_MSg, Generics.Collections, prm_vehicle_brand, controllerfornecedor;
  ...
  Try
    ...
    Begin
      ...
      Begin
        ...
        get(Lc_Qry, LITem);
        Lista.add(LITem);
        LITem.CodigoModelo    := FieldByName('MOD_CODIGO').AsInteger;
