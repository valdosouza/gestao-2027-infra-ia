...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblCartao, Un_sistema, Un_Regra_Negocio, tblCustoPedido, ControllerProduto;
...
Type
  ...
  public
    ...
    procedure clear;
    procedure AtualizarUltimoCusto(pData:TDatetime;Hora:TTime;ProdutoID:Integer;UltimoCusto:Real);
  End;
...
procedure TControllerCustoPedido.AtualizarUltimoCusto(pData:TDatetime;Hora:TTime;ProdutoID:Integer;UltimoCusto:Real);
Var
  Lc_Qry : TSTQuery;
begin
  Try
    ...
    Begin
      ...
      ParamByName('nfl_dt_emissao').AsDateTime := pData;
...
begin
  ...
  Try
    witH Lc_Qry do
    Begin
      sql.add('SELECT CAST(COALESCE(SUM(CTP_VL_REAL), 0) AS NUMERIC(18, 2)) TOTAL '+
...
procedure TControllerCustoPedido.update;
begin
  updateObj(registro);
end;

procedure TControllerCustoPedido.delete;
begin
  deleteObj(Registro);
end;
