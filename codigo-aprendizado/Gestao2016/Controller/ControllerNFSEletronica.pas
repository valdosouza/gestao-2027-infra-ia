...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, Un_sistema, Un_Regra_Negocio, tblNFSEletronica, pcnConversao, Vcl.ExtCtrls, ACBrDFeSSL, blcksock, Vcl.Forms, ControllerEstabelecimento, synacode, ACBrNFSeX, ACBrNFSeXConversao, System.AnsiStrings;
...
Begin
  ...
  Begin
    ...
    //Layout
    Configuracoes.Geral.LayoutNFSe := TLayoutNFSe(StrToIntDef(Registro.LayoutNFse,0));
    //FormatoDiscr
    Configuracoes.Geral.FormatoDiscriminacao := TFormatoDiscriminacao(StrToIntDef(Registro.FormatoDiscr,0));
...
    case AnsiIndexStr(Registro.provedor, ['PadraoNacional','ISSNet','IPMSistemas']) of
    ...
    begin
      ...
      Nfse.DANFSe.TipoDANFSE := tpPadraoNacional;
    end;
