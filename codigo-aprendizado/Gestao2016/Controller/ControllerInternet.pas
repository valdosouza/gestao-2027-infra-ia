...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblInternet, Un_MSg, Generics.Collections;
...
begin
  ...
  Try
    ...
    Begin
      ...
      ParamByName('INT_CODMHA').AsInteger := Registro.Estabelecimento;
      Active := True;
      FetchAll;
      exist := recordCount > 0;
      if exist then
