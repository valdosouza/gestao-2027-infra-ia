...
interface
uses     ControllerPedido, ControllerCliente, System.Classes, ControllerColaborador, System.SysUtils, ObjOrderSale, tblPEdido, TblOrderItem, ObjCustomer, STQuery, ControllerBase;
...
begin
  ...
  Obj.Totalizer.AliquotaDesconto  := PcRegistro.AliqDesconto;
...
begin
  ...
  Try
    ...
    Begin
      ...
      //Passagem de Parametros
      ParamByName('PEG_CODPED').AsInteger       := Registro.Codigo;
      ParamByName('PEG_TM_PEDIDO').AsString := Copy(TimeToStr(now),1,5);
      ExecSQL;
    end;
  Finally
    FinalizaQuery(Lc_Qry);
