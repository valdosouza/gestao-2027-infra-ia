...
uses     STDatabase, System.Classes, System.SysUtils, ControllerBase, tblConserto, Md5, STQuery, ControllerElectEquip, ControllerAnnotation, ControllerNotaFiscal;
Type
...
procedure TControllerConserto.update;
begin
  updateObj(Registro);
end;
