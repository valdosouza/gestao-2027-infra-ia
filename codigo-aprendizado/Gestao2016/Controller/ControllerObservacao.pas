...
uses     System.Classes, System.SysUtils, Generics.Collections, STQuery, ControllerBase, tblObservacao, prm_note;
...
begin
  ...
  Try
    with Lc_Qry do
    Begin
      SQL.Text := concat(' SELECT * ',
                         'FROM tb_observacao ',
                         'where OBS_CODMHA =:OBS_CODMHA ');
      ParamByName('OBS_CODMHA').AsInteger := FParametros.Estabelecimento;
