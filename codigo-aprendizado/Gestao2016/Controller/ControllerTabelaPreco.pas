...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblTabelaPreco, Un_MSg, Generics.Collections, ControllerPreco, ControllerTabelaPrecoHasFormaPagto;
...
begin
  FreeAndNil(Lista);
  FreeAndNil(ListaSplFormaPAgto);
  FreeAndNil(HasFormaPAgto);
  FreeAndNil(Preco);
  FreeAndNil(Registro);
  inherited;
end;
