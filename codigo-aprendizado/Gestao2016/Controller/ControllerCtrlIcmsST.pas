...
interface
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblCtrlIcmsST, Generics.Collections;
    ...
    Begin
      ...
      Begin
        ...
        Begin
          ...
          LCItem.ValorICMSSubstituto  := LCItem.ValorICMSSubstituto + FieldByName('VICMSSUBSTITUTO').AsCurrency;
          LCItem.ValorICMSSTRetido    := LCItem.ValorICMSSTRetido   + FieldByName('VICMSSTRET').AsCurrency;
          Next;
        End;
        Registro := LCItem;
      End;
  ...
  Try
    ...
    Begin
      ...
      Begin
        ...
        LCItem.ValorICMSSubstituto := Lc_Qry.FieldByName('VICMSSUBSTITUTO').AsCurrency / F;
        LCItem.ValorICMSSTRetido   := Lc_Qry.FieldByName('VICMSSTRET').AsCurrency / F;
        LCItem.Destino             := 0;
        insertObj(LCItem);
      End;
      Lc_Qry.Next;
