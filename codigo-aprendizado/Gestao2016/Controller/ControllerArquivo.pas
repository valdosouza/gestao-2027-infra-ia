...
interface
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, Un_sistema, tblArquivo, Data.DB, Generics.Collections, synacode, objFile;
  ...
  Try
    ...
    Begin
      ...
      case pReg.TipoDoArquivo of
        1:Begin
            obj.FolderName := 'NFE';  //1 - Arquivo de XML da Nota Fiscal Eletronica Pr�pria
        ...
        3:Begin
            obj.FolderName := 'NFTE';  //3 - Arquivo de XML da Nota Fiscal Eletr�nica de Terceiros
            LcPos := Pos('Id="NFe', LcConteudo) + 7;
            Obj.Filename := concat(Copy(LcConteudo,LcPos,44),'-nfe.xml');
          end;
        4:Begin
      ...
      { Prepara o conte�do bin�rio, codificando-o como um texto }
...
BEGIN
  {
   1 - Arquivo de XML da Nota Fiscal Eletronica Pr�pria
   2 - Arquivo de XML da Carta de Correção
   3 - Arquivo de XML da Nota Fiscal Eletr�nica de Terceiros
