...
uses     System.Classes, System.SysUtils, Generics.Collections, STQuery, ControllerBase, tblCidade, prm_cidade;
...
procedure TControllerCidade.getbyIBGE;
Var
  Lc_Qry : TSTQuery;
begin
  Lc_Qry := GeraQuery;
  Try
    ...
    Begin
      SQL.Add('select CDD_CODIGO FROM TB_CIDADE WHERE CDD_IBGE=:CDD_IBGE');
      ParamByName('CDD_IBGE').AsInteger := Registro.IBGE;
      Active := True;
      FetchAll;
      exist := Recordcount > 0;
      IF exist then
