...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, Un_sistema, Un_Regra_Negocio, tblProduction, Un_MSg, ControllerProductionForeCast, ControllerProductionRealized, ControllerCtrlEstoque;
...
begin
  ...
  FreeAndNil(ProducaoRealizada);
  FreeAndNil(ProducaoPrevista);
  FreeAndNil(Registro);
  inherited;
end;
