...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, Un_sistema, tblREtornoNFS, ControllerLoteNfse, ControllerRpsNfse, ControllerNFSEletronica, ObjInvoiceReturnService, ControllerGestaoWeb, Generics.Collections;
...
procedure TControllerRetornoNFS.deleteNfe;
Var
  Lc_Qry : TSTQuery;
begin
  Lc_Qry := GeraQuery;
  Try
    ...
    Begin
      sql.add(concat(
                'DELETE FROM TB_RETORNO_NFS '+
                ' WHERE NFS_CODNFL =:NFL_CODIGO '
      ));
