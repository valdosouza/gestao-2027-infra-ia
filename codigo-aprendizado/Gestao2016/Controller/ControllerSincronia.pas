...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, Un_sistema, tblSincronia, ControllerDskRestMenu, Generics.Collections, controllerDskSyncTable, ControllerEstoque;
...
Type
  ...
  public
    ...
    SyncClient : TControllerDskSyncTable;
...
begin
  ...
  SyncClient := TcontrollerDskSyncTable.Create(Self);
end;
 ...
 //Seleciona REgistros do Servidor
  ...
  try
    ...
    Begin
      ...
      FetchAll;
      First;
      Lista.Clear;  // Reutiliza a lista existente (criada no constructor)
      while not eof do
      Begin
        LcLista := TSincronia.Create;
        LcLista.Codigo   := 0;
