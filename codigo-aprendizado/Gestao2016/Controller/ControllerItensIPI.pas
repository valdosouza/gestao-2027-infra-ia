...
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, tblItensipi, Generics.Collections, controllerProduto;
...
procedure TControllerItensIPI.deletebyNF;
Var
  Lc_Qry : TSTQuery;
Begin
  Lc_Qry := GeraQuery;
