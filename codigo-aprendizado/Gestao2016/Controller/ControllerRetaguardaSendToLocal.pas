...
uses
       Classes, System.SysUtils, System.StrUtils, Gauges, Vcl.Forms, STDatabase, ControllerSincronia, ControllerEmpresa, ControllerEndereco, ControllerGrupos, ControllerSubGrupos, ControllerMarcaProduto, ControllerMedida, ControllerEmbalagem, ControllerProduto, ControllerPreco, ControllerTabelaPreco, ControllerFormaPagamento, ControllerColaborador, ControllerUsuario, ControllerCargo, ControllerEstoque, ControllerEstoques, tblEmpresa, tblSincronia, tblDskSyncTable;
