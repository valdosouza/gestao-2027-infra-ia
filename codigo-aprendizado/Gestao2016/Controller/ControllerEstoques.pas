...
uses     System.Classes, System.SysUtils, Generics.Collections, STQuery, ControllerBase, tblEstoques, prm_stocks, Vcl.Forms, ControllerEstoque;
...
Type
  ...
  public
    ...
    procedure CriaRegistroEstoque(Pc_Cd_Estoque: Integer);
...
begin
  ...
  SaldoEstoque := TControllerEstoque.Create(Self);
end;
...
procedure TControllerEstoques.CriaRegistroEstoque(Pc_Cd_Estoque : Integer);
Var
...
begin
  ...
  try
    ...
    FinalizaQuery( Lc_Qry_Produtos);
    FinalizaQuery( Lc_Qry_Insere);
  end;
end;
