...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, tblParcelamento, Generics.Collections;
Type
...
begin
  ...
  Try
    ...
    Begin
      ...
      sql.Clear;
      sql.add(concat(
              'SELECT CAST(COALESCE(SUM(p.par_valor), 0) AS NUMERIC(18, 2)) valor ',
