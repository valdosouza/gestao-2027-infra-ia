...
uses     System.Classes, System.SysUtils, ControllerBase, tblDskCategory, STQuery, System.Generics.Defaults, System.Generics.Collections, UnFunctions;
...
begin
  ...
  Try
    ...
    Begin
      ...
      ParamByName('DESCRIPTION').AsString := Pc_Subgrupo;
      ParamByName('POSIT_LEVEL').AsString := NivelPosicao;
      Active := True;
      FetchAll;
      exist := ( recordCount>0 );
      if exist then
