...
uses     System.Classes, System.SysUtils, Generics.Collections, STQuery, ControllerBase, tblInterface, prm_interface, ControllerMenus, ControllerOperInterface, ControllerItensIfc;
...
procedure TControllerInterface.replace;
begin
  replaceObj(registro)
end;
