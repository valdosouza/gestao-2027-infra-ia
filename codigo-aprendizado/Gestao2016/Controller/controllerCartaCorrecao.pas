...
uses     STDatabase, System.Classes, System.SysUtils, ControllerBase, tblCartaCorrecao, Md5, STQuery, Generics.Collections, objInvoiceRectification, ControllerGestaoWeb;
...
begin
  try
    if Registro.Codigo = 0 then
      Registro.Codigo := Generator('GN_CARTA_CORRECAO');
    insertObj(Registro);
    Result := true;
  except
    Result := False;
