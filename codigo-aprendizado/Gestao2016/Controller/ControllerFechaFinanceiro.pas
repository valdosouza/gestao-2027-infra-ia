...
interface
uses     STDatabase, Classes, Vcl.Grids, STQuery, SysUtils, ControllerBase, Un_sistema, Un_Regra_Negocio, tblFechaFinanceiro;
...
Type
  ...
  public
    ...
    function getSaldoAnterior(Codigo:Integer;pData:TDate):Real;
  End;
