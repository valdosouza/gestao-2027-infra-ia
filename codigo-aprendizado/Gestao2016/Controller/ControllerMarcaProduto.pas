...
uses     STDatabase, System.Classes, Vcl.Grids, STQuery, System.SysUtils, ControllerBase, tblMarcaProduto, Un_MSg, System.Generics.Collections, prm_product_brand;
  ...
  Try
    ...
    Begin
      ...
      SQL.Add('SELECT * '+
              ...
              ' AND ( (MRC_CODIGO <>:MRC_CODIGO) AND (MRC_CODIGO >0) ) '
              );
      ParamByName('MRC_DESCRICAO').AsString := UpperCase( Registro.Descricao );
      ParamByName('MRC_CODIGO').AsInteger := Registro.Codigo ;
      Active := True;
      FetchAll;
      First;
      exist := RecordCount > 0 ;
