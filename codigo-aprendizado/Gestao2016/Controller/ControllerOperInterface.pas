...
uses     System.Classes, System.SysUtils, Generics.Collections, STQuery, ControllerBase, tblOperInterface, prm_oper_interface, Data.DB, EncdDecd, synacode;
...
Type
  ...
  public
    ...
    function replaceByInternet:boolean;
...
function TControllerOperInterface.replaceByInternet: boolean;
var
  Lc_Qry : TSTQuery;
