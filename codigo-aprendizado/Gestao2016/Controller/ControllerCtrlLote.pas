...
uses     STDatabase, Classes, STQuery, SysUtils, ControllerBase, tblCtrlLote, Generics.Collections, controllerProduto, ControllerCtrlEstoque, ControllerMovimentoLote;
  ...
  Try
    ...
    Begin
      ...
      if RecordCount > 0 then
        Result := FieldByName('CLT_QT_SALDO').AsCurrency;
    End;
  Finally
    FinalizaQuery(Lc_Qry);
  End;
...
begin
  ...
  try
    ...
    Begin
      ...
      ParamByName('CLT_NUMERO').AsString:= Registro.Numero;
