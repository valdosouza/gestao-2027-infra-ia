...
uses     ControllerPedido, tblOrder, tblOrderStockAdjust, tblOrderItem, objORderStockAdjust, System.SysUtils, ObjCustomer, tblPedido, System.Classes, objOrderBonus;
...
begin
  ...
  Begin
    ...
    End;
    //Quando tiver observção no cliente junta os dois
    ...
    Begin
      //Aqui coloca somente a observção do pedido
    ...
    Begin
      ...
      Itens.Produto.TabelaPreco.Preco.Registro.CodigoTabela := 1;
      Itens.Produto.TabelaPreco.Preco.Registro.CodigoProduto := pOrder.Items[I].Produto;
      Itens.Produto.TabelaPreco.Preco.getByTabelaProduto;
      ...
      BEgin
        ...
        ValorCusto        := 0;
        ValorUnitario     := Itens.Produto.TabelaPreco.Preco.Registro.Valor;
        Despachar         := 'S';
        Estoque           := 'S';
        AliqComissao      := 0;
        ValorDesconto     := 0;
