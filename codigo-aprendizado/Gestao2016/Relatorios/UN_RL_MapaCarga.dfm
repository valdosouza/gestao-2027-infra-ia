object RL_MapaCarga: TRL_MapaCarga
  Left = 263
  Top = 114
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = False
    ReportTitle = 'Mapa de Carregamento'
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object Qr_MapaCarga: TSTQuery
    ...
    Left = 248
    Top = 16
    object Qr_MapaCargaPED_DATA: TDateField
      FieldName = 'PED_DATA'
      Origin = 'TB_PEDIDO.PED_DATA'
      Required = True
    end
    object Qr_MapaCargaPED_CODIGO: TIntegerField
      FieldName = 'PED_CODIGO'
      Origin = 'TB_PEDIDO.PED_CODIGO'
      Required = True
    end
    object Qr_MapaCargaPED_NUMERO: TIntegerField
      FieldName = 'PED_NUMERO'
      Origin = 'TB_PEDIDO.PED_NUMERO'
    end
    object Qr_MapaCargaEMP_FANTASIA: TStringField
      FieldName = 'EMP_FANTASIA'
      Origin = 'TB_EMPRESA.EMP_FANTASIA'
      Size = 100
    end
    object Qr_MapaCargaCLB_NOME: TStringField
      FieldName = 'CLB_NOME'
      Origin = 'TB_COLABORADOR.CLB_NOME'
      Size = 100
    end
    object Qr_MapaCargaPED_VL_PEDIDO: TBCDField
      FieldName = 'PED_VL_PEDIDO'
      Origin = 'TB_PEDIDO.PED_VL_PEDIDO'
      Precision = 18
      Size = 2
    end
    object Qr_MapaCargaPRO_DESCRICAO: TStringField
      FieldName = 'PRO_DESCRICAO'
      Origin = 'TB_PRODUTO.PRO_DESCRICAO'
      Size = 100
    end
    object Qr_MapaCargaITF_QTDE: TBCDField
      FieldName = 'ITF_QTDE'
      Origin = 'TB_ITENS_NFL.ITF_QTDE'
      Precision = 18
      Size = 3
    end
    object Qr_MapaCargaITF_VL_UNIT: TFloatField
      FieldName = 'ITF_VL_UNIT'
      Origin = 'TB_ITENS_NFL.ITF_VL_UNIT'
    end
    object Qr_MapaCargaPED_CODVDO: TIntegerField
      FieldName = 'PED_CODVDO'
      Origin = 'TB_PEDIDO.PED_CODVDO'
      Required = True
    end
    object Qr_MapaCargaEMB_ABREVIATURA: TStringField
