object RL_MapaCargaFinanceiro: TRL_MapaCargaFinanceiro
  Left = 441
  Top = 187
  Caption = 'Mapa de carregamento - Financeiro'
  ClientHeight = 556
  ClientWidth = 864
  Color = clBtnFace
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = False
    ReportTitle = 'Mapa de carregamento - Financeiro'
    ShowProgress = False
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRBand2: TQRBand
      ...
      object QRLabel7: TQRLabel
        ...
        AlignToBand = False
        AutoSize = False
        Caption = 'M'#233'd. Positiva'#231#227'o'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object E_Med_Positivacao: TQRLabel
        Left = 621
        Top = 41
        Width = 92
        Height = 17
  ...
  object Qr_MapaCarga: TSTQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT PED_DATA, PED_CODIGO, PED_NUMERO, EMP_NOME, '
