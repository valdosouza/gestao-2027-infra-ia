object RL_Ajuste: TRL_Ajuste
  Left = 197
  Top = 174
  Caption = 'Relat'#243'rio de Ajustes de Estoque'
  ClientHeight = 532
  ClientWidth = 823
  Color = clBtnFace
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = False
    ReportTitle = 'Relat'#243'rio de Ajustes de Estoque'
    ShowProgress = False
    SnapToGrid = True
    Units = Pixels
    Zoom = 100
    ...
    object DetalheVenda: TQRBand
      ...
      object E_NomeFantasia: TQRDBText
        Left = 324
        Top = 1
        Width = 334
        Height = 17
