object RL_Comi_Previsao: TRL_Comi_Previsao
  Left = 204
  Top = 129
  ...
  object Qrpt: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        Expression = 'sum(Qr_Comissao.NFL_VL_TL_NOTA)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object Qr_Comissao: TSTQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DISTINCT CLB_CODIGO,PED_CODIGO, PED_DATA, PED_NUMERO, PED' +
        '_CODEMP, EMP_NOME, PED_CODVDO,'
      'CLB_NOME, NFL_VL_TL_NOTA         '
      ...
      'ORDER BY CLB_CODIGO, NFL_DT_EMISSAO,NFL_NUMERO, EMP_NOME'
      ''
      '')
    Left = 88
    Top = 32
