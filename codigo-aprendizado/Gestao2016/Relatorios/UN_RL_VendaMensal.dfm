object RL_VendaMensal: TRL_VendaMensal
  Left = 208
  Top = -2
  Caption = 'Rela'#231#227'o de Vendas - Mensal'
  ClientHeight = 700
  ClientWidth = 817
  Color = clBtnFace
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Rela'#231#227'o de Vendas - Mensal'
    ShowProgress = False
    SnapToGrid = True
    Units = Pixels
    Zoom = 100
  ...
  object Qr_Vendas: TSTQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT SUM(NFL_VL_TL_NOTA) VDA_VL_TOTAL'
