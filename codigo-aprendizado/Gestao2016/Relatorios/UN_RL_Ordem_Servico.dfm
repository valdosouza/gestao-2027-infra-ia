object RL_Ordem_Servico: TRL_Ordem_Servico
  Left = 182
  Top = 207
  ...
  object Qrpt: TQuickRep
    ...
    object QRBand4: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        Expression = 'SUM(Qr_Servicos.PED_VL_PRODUTO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr2: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'SUM(Qr_Servicos.PED_VL_SERVICO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr3: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'SUM(Qr_Servicos.PED_VL_PEDIDO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object Qr_Servicos: TSTQuery
    ...
    SQL.Strings = (
        ...
        'SELECT NFL_DT_EMISSAO AS DATA, ORD_NUMERO, VEI_FROTA, VEI_PLACA,' +
        ' EMP_FANTASIA, PED_VL_SERVICO, PED_VL_PRODUTO, PED_VL_DESCONTO, ' +
        'PED_VL_PEDIDO, EMP_NOME'
    ...
    Left = 328
    Top = 8
    object Qr_ServicosORD_NUMERO: TStringField
      FieldName = 'ORD_NUMERO'
      Origin = 'TB_ORDEMSERVICO.ORD_NUMERO'
      Required = True
    end
    object Qr_ServicosVEI_PLACA: TStringField
      FieldName = 'VEI_PLACA'
      Origin = 'TB_VEICULO.VEI_PLACA'
      Required = True
      Size = 7
    end
    object Qr_ServicosEMP_FANTASIA: TStringField
      FieldName = 'EMP_FANTASIA'
      Origin = 'TB_EMPRESA.EMP_FANTASIA'
      Size = 100
    end
    object Qr_ServicosPED_VL_SERVICO: TBCDField
      FieldName = 'PED_VL_SERVICO'
      Origin = 'TB_PEDIDO.PED_VL_SERVICO'
      Precision = 18
      Size = 2
    end
    object Qr_ServicosPED_VL_PRODUTO: TBCDField
      FieldName = 'PED_VL_PRODUTO'
      Origin = 'TB_PEDIDO.PED_VL_PRODUTO'
      Precision = 18
      Size = 2
    end
    object Qr_ServicosPED_VL_DESCONTO: TBCDField
      FieldName = 'PED_VL_DESCONTO'
      Origin = 'TB_PEDIDO.PED_VL_DESCONTO'
      Precision = 18
      Size = 2
    end
    object Qr_ServicosPED_VL_PEDIDO: TBCDField
      FieldName = 'PED_VL_PEDIDO'
      Origin = 'TB_PEDIDO.PED_VL_PEDIDO'
      Precision = 18
      Size = 2
    end
    object Qr_ServicosDATA: TDateField
      FieldName = 'DATA'
      Origin = 'TB_NOTA_FISCAL.NFL_DT_EMISSAO'
    end
    object Qr_ServicosEMP_NOME: TStringField
      FieldName = 'EMP_NOME'
      Origin = 'TB_EMPRESA.EMP_NOME'
      Size = 100
    end
    object Qr_ServicosVEI_FROTA: TStringField
      FieldName = 'VEI_FROTA'
      Origin = 'TB_VEICULO.VEI_FROTA'
      Size = 30
    end
  end
end
