...
procedure TRL_Comi_Resum.Pc_Busca;
begin
...
procedure TRL_Comi_Resum.QrptBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TRL_Comi_Resum.setFParamComissao(const Value: TParamComissao);
begin
  FParamComissao := Value;
end;

procedure TRL_Comi_Resum.Pc_Parametros;
begin
