object RL_Comi_Detal_Vend_Cidade: TRL_Comi_Detal_Vend_Cidade
  Left = 308
  Top = 118
  Caption = 'Comiss'#227'o Detalhada por Vendedor e Cidade'
  ClientHeight = 542
  ClientWidth = 792
  Color = clBtnFace
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = False
    ReportTitle = 'Comiss'#227'o Detalhada por Vendedor e Cidade'
    ShowProgress = False
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'Qr_Comissao.CDD_CODIGO'
      FooterBand = foot_Cidade
      Master = Qrpt
      ReprintOnNewPage = False
  ...
  object Qr_Comissao: TSTQuery
    ...
    SQL.Strings = (
        ...
        'SELECT COM_CODIGO, COM_DT_VENDA, COM_CODPED,PED_NUMERO, COM_CODE' +
        'MP, EMP_NOME,  COM_CODVDO, '
      
        'CLB_NOME, COM_VL_DOC, COM_AQ_COM, COM_VL_COM, COM_DT_PAGTO, CLB_' +
        'CODIGO, CDD_CODIGO, CDD_DESCRICAO'
