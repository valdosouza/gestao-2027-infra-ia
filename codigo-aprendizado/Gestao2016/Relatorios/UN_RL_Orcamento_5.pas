...
var
  RL_Orcamento_5: TRL_Orcamento_5;

implementation

uses     Un_Cotacao, Un_Funcoes, UN_Sistema, Un_DM, UN_Pedido_Vda, UN_RL_Orcamento_3, Un_Regra_Negocio, Un_Cotacao_Cfc;
{$R *.dfm}
Procedure TRL_Orcamento_5.PC_VAlidaCampos(Pc_Print : Boolean);
Begin
  if Pc_Print then
    BEgin
...
Procedure TRL_Orcamento_5.Pc_PreencheGrade;
Var
  Lc_I : integer;
  Lc_Name : String;
Begin
...
Procedure TRL_Orcamento_5.PC_PreencheCampos;
Begin
...
procedure TRL_Orcamento_5.Pc_Orcamento;
Var
...
begin
  ...
  if Assigned(Fr_Cotacao_Cfc) then Lb_Orcamento.Caption := 'Orçamento Nº '+ Qr_Ordem.FieldByName('CTC_NUMERO').AsString;
  if Assigned(Fr_Pedido_Vda) then Lb_Orcamento.Caption := 'Orçamento Nº '+ Qr_Ordem.FieldByName('CTC_NUMERO').AsString + ' - Pedido Nº ' + Qr_Ordem.FieldByName('PED_NUMERO').AsString;
...
procedure TRL_Orcamento_5.DetalheVendaBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRL_Orcamento_5.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
Var
  Lc_I : Integer;
begin
...
procedure TRL_Orcamento_5.FormClose(Sender: TObject;
...
procedure TRL_Orcamento_5.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRL_Orcamento_5.QrptBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
