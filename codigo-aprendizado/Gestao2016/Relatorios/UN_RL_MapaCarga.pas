...
type
  TRL_MapaCarga = class(TForm)
    ...
    QRLabel10: TQRLabel;
    QRExpr5: TQRExpr;
    Qr_MapaCargaPED_DATA: TDateField;
    Qr_MapaCargaPED_CODIGO: TIntegerField;
    Qr_MapaCargaPED_NUMERO: TIntegerField;
    Qr_MapaCargaEMP_FANTASIA: TStringField;
    Qr_MapaCargaCLB_NOME: TStringField;
    Qr_MapaCargaPED_VL_PEDIDO: TBCDField;
    Qr_MapaCargaPRO_DESCRICAO: TStringField;
    Qr_MapaCargaITF_QTDE: TBCDField;
    Qr_MapaCargaITF_VL_UNIT: TFloatField;
    Qr_MapaCargaPED_CODVDO: TIntegerField;
    QRLabel11: TQRLabel;
    QRDBText1: TQRDBText;
    Qr_MapaCargaEMB_ABREVIATURA: TStringField;
...
var
  RL_MapaCarga: TRL_MapaCarga;

implementation

uses     UN_Sistema, UN_Imp_MapaCarga;
{$R *.dfm}
procedure TRL_MapaCarga.Pc_Buscar;
Var
  SqlTxt : String;
  Lc_I : Integer;
...
procedure TRL_MapaCarga.QrptBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TRL_MapaCarga.FormClose(Sender: TObject;
