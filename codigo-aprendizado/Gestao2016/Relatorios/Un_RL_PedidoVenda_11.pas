unit Un_RL_PedidoVenda_11;

interface

uses
      Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, DB, STQuery, QuickRpt, QRCtrls, ExtCtrls, QRPDFFilt, grimgctrl, StdCtrls, jpeg, DBCtrls, System.Math, qrpctrls;

type
  TRL_PedidoVenda_11 = class(TForm)
    Qr_Itens: TSTQuery;
...
var
  RL_PedidoVenda_11: TRL_PedidoVenda_11;

implementation

uses     UN_Sistema, Un_DM, UN_Pedido_Vda, Un_Funcoes, Un_Regra_Negocio, RN_Financeiro, env;
{$R *.dfm}
procedure TRL_PedidoVenda_11.Pc_IniciaVariaveis;
Begin

end;

procedure TRL_PedidoVenda_11.Pc_Parcelamento;
Var
...
Procedure TRL_PedidoVenda_11.Pc_Historico;
Var
  Lc_TExto : String;
...
procedure TRL_PedidoVenda_11.PC_TotalizarCustos;
Var
  Lc_Altura : Integer;
  Lc_Obs : TMemo;
  LcLote : String;
...
procedure TRL_PedidoVenda_11.PC_VAlidaCustos(Pc_Print: Boolean);
Var
  Lc_Altura:Integer;
Begin
...
Procedure TRL_PedidoVenda_11.PC_VAlidaProdutos(Pc_Print : Boolean);
Var
  Lc_Altura:Integer;
Begin
...
procedure TRL_PedidoVenda_11.PC_PreencheCustos;
Var
  Lc_Altura : Integer;
  Lc_Obs : TMemo;
  LcLote : String;
...
Procedure TRL_PedidoVenda_11.PC_PreencheProdutos;
Var
  Lc_Altura : Integer;
  Lc_Obs : TMemo;
  LcLote : String;
...
procedure TRL_PedidoVenda_11.Pc_Cabecalho;
Var
  LcFone : String;
begin
...
procedure TRL_PedidoVenda_11.Pc_Rodape;
Var
  Lc_I : Integer;
...
procedure TRL_PedidoVenda_11.FormClose(Sender: TObject;
...
procedure TRL_PedidoVenda_11.QrptBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
Var
  Lc_I : Integer;
  Lc_Itens : Integer;
...
procedure TRL_PedidoVenda_11.Qr_ItensAfterOpen(DataSet: TDataSet);
begin
...
procedure TRL_PedidoVenda_11.Bd_DetalheCustoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRL_PedidoVenda_11.Bd_DetalhePedidoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRL_PedidoVenda_11.RodapeBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  Pc_Rodape;
end;

procedure TRL_PedidoVenda_11.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
VAR
 Lc_CPF_CNPJ:String;
begin
...
function TRL_PedidoVenda_11.Fc_BuscaLote(CodigoViculo : Integer):String;
Var
  SqlTxt : String;
  Lc_I : Integer;
