object RL_Orcamento_7: TRL_Orcamento_7
  Left = 207
  Top = 360
  ...
  object Qr_Cotacao: TSTQuery
    ...
    SQL.Strings = (
      ...
      '  on (pd.ped_codigo = ct.ctc_codped)'
      '  LEFT OUTER JOIN TB_EMPRESA ep'
      '  ON (ep.EMP_CODIGO = ct.CTC_CODEMP)'
      '  LEFT OUTER JOIN TB_ENDERECO ed'
      '  ON (pd.ped_codend = ed.END_CODIGO)'
      ''
      '  LEFT OUTER JOIN TB_CIDADE cd'
