object RL_TabelaProduto: TRL_TabelaProduto
  Left = 206
  Top = 97
  ...
  object Qrpt: TQuickRep
    ...
    PrintIfEmpty = False
    ReportTitle = 'Tabela de Produtos'
    ShowProgress = False
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRGroup1: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'Qr_Produtos.PRO_CODGRP'
      Master = Qrpt
    ...
    object QRGroup2: TQRGroup
      ...
      PreCaluculateBandHeight = False
      KeepOnOnePage = False
      Expression = 'Qr_Produtos.PRO_CODSBG'
      Master = Qrpt
      ReprintOnNewPage = True
  ...
  object Qr_Produtos: TSTQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DISTINCT PRO_CODIGO, PRO_DESCRICAO,  PRO_CODGRP, PRO_CODS' +
        'BG,  '
      
        'PRC_VL_VDA , GRP_DESCRICAO, SBG_DESCRICAO,  PRO_CODIGOFAB, EMB_D' +
        'ESCRICAO, MED_DESCRICAO, PRO_DIVISOR '
      ...
      '             LEFT OUTER JOIN TB_EMBALAGEM Tb_embalagem '
        ...
        '             ON  (Tb_embalagem.EMB_CODIGO = Tb_produto.PRO_CODEM' +
        'B) '
      '             LEFT OUTER JOIN TB_PROD_FORN Tb_prod_forn '
      
        '             ON  (Tb_prod_forn.PFR_CODPRO = Tb_produto.PRO_CODIG' +
        'O) '
      '             LEFT OUTER JOIN  TB_EMPRESA Tb_fornecedor '
      
        '             ON  (Tb_prod_forn.PFR_CODFOR = Tb_fornecedor.EMP_CO' +
        'DIGO) '
