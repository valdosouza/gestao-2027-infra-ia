...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Mask, Vcl.Buttons, Vcl.ExtCtrls, FavoritoButtons;
...
begin
  ...
  Result := MensagemPadrao(TITULO_CONFIRMACAO, Msg, [OK],[bEscape], mpConfirmacao, clBtnFace);
end;
...
var
  Msg: String;
begin
  Msg := TITULO_CONFIRMACAO+ EOLN + EOLN +
          info + EOLN;
...
class function TMsgSetes.ConfirmaAcao(info:String): Integer;
var
  Msg: String;
begin
  Msg := TITULO_CONFIRMACAO+ EOLN + EOLN +
