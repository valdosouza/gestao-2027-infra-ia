...
type
  ...
  (* IMPORTANTE - Sempre que alterar um Tipo efetuar a atualizção das funções de convers�o correspondentes *)
...
begin
  ...
  // ID -> N03 - Tributada e com cobran�a do ICMS por substituição tributária
  // ID -> N04 - Com redução de base de cálculo
  // ID -> N05 - Isenta ou não tributada e com cobran�a do ICMS por substituição tributária
  // ID -> N06 - Isenta
  // ID -> N06 - Não tributada
  // ID -> N06 - Suspens�o
  // ID -> N07 - Diferimento A exig�ncia do preenchimento das informações do ICMS diferido fica � crit�rio de cada UF.
  // ID -> N08 - ICMS cobrado anteriormente por substituição
  // ID -> N09 - Com redução de base de cálculo e cobran�a do ICMS por substituição tributária
  // ID -> N10 - Outros
...
// N13 - Modalidade de determinção da BC do ICMS ******************************

function modBCToStr(const t: TpcnDeterminacaoBaseIcms): string;
begin
  // 0 - Margem Valor Agregado (%);
  // 1 - Pauta (Valor);
  // 2 - Preço Tabelado M�x. (valor);
  // 3 - valor da operção.
...
// N18 - Modalidade de determinção da BC do ICMS ST ***************************
