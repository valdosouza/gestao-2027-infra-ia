...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Data.DB, UN_Principal, env, STQuery, Vcl.DBCtrls, Vcl.Buttons, Vcl.StdCtrls;
...
uses     UN_Sistema, sea_collaborator, RN_Permissao, Un_Regra_Negocio, PrintPizzaria, Un_DM;
...
begin
  ...
  Begin
    Lc_Form := TSeaCollaborator.Create(Self);
    Try
      Lc_Form.ShowModal;
    Finally
      Listar;
