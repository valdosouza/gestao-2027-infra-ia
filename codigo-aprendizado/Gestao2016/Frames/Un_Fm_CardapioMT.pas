...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ComCtrls, Vcl.Buttons, Vcl.Grids, Vcl.ExtCtrls, Un_Fm_CardapioPanel, Data.DB, STQuery, Vcl.StdCtrls, Un_Fm_ListaGrupoSubGrupo, Vcl.Menus, ControllerMedida;
...
uses     Un_CardapioProduto, Un_CardapioTamanho, Un_DM, Un_Regra_Negocio, ControllerCardapio, Un_Msg;
...
begin
  ...
  Begin
    ...
    Begin
      ...
      //Preço Normal
      Cells[5,I] := FloatToStrF( FieldByName('PRO_VL_NORMAL').AsCurrency,ffFixed,10,2);
      //Preço Promoção
      Cells[6,I] := FloatToStrF( FieldByName('PRO_VL_PROMOCAO').AsCurrency,ffFixed,10,2);
      Inc(I);
      Next;
    end;
  end
