...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.DBCtrls, Data.DB, STQuery, Vcl.Buttons,
...
type
  TFm_ListaEstoques = class(TFrame)
    ...
    Qr_EstoquesETS_DESCRICAO: TStringField;
    Qr_EstoquesETS_PRINCIPAL: TStringField;
...
uses     Un_DM, UN_Sistema, sea_stocks, RN_Permissao, Un_Principal, env;
...
begin
  ...
  Begin
    Lc_Form := TSeaStocks.Create(Self);
    Try
      Lc_Form.ShowModal;
    Finally
