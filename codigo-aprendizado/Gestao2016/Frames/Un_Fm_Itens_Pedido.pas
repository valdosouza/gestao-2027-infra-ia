...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Grids, Data.DB, STQuery, Vcl.Menus, System.Math, Un_Ctrl_Lote_Saida;
...
type
  TFm_Itens_Pedido = class(TFrame)
    ...
    Qr_ItensNotaIAV_DESCRICAO: TStringField;
    ...
    Qr_ItensNotaIAV_UNIDADE: TStringField;
...
begin
  ...
  Begin
    ...
    Begin
      ...
      //ITF_VL_CUSTO
      Cells[9,Lc_registro] :=  FloatToStrF( FieldByName('ITF_VL_CUSTO').AsCurrency,ffNumber,10,2);
      //ITF_VL_UNIT
      Cells[10,Lc_registro] := formatFloat('#,##0.00####', FieldByName('ITF_VL_UNIT').AsCurrency);
      //ITF_AQ_COM
      ...
      //ITF_VL_DESC
      Cells[15,Lc_registro] := FloatToStrF( FieldByName('ITF_VL_DESC').AsCurrency,ffNumber,10,2);
      //PRO_VL_CUSTOMED
      Cells[16,Lc_registro] := FloatToStrF( FieldByName('PRO_VL_CUSTOMED').AsCurrency,ffNumber,10,2);
      //ITF_VL_IPI
      Cells[17,Lc_registro] := FloatToStrF( FieldByName('ITF_VL_IPI').AsCurrency,ffNumber,10,2);
      //ITF_VL_SUBTOTAL
      Cells[18,Lc_registro] := FloatToStrF( FieldByName('ITF_VL_SUBTOTAL').AsCurrency,ffNumber,10,2);
      //ITF_VL_TOTAL
      Cells[19,Lc_registro] := FloatToStrF( FieldByName('ITF_VL_TOTAL').AsCurrency,ffNumber,10,2);
      Next;
      inc(Lc_registro);
    end;
    Repaint;
...
begin
  ...
  Begin
    ...
    FieldByName('ITF_VL_SUBTOTAL').AsCurrency :=
