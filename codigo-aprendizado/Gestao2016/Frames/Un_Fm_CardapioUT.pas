...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Un_Fm_CardapioPanel, Vcl.Grids, ControllerPreco, Un_Principal, env, Un_Crp_Itens, Vcl.Menus;
...
uses     Un_CardapioProduto, Un_Regra_Negocio, UN_Sistema, ControllerCardapio, Un_Msg, Un_Fm_CardapioMT;
...
begin
  ...
  Begin
    ...
    Begin
      ...
      //codcódcódcódigo do produto
      Cells[1,I] := FieldByName('PRO_CODIGO').AsString;
      //Descrição da produto
      Cells[2,I] := FieldByName('PRO_DESCRICAO').AsString;
      //Preço Normal
      Cells[3,I] := FloatToStrF( FieldByName('PRO_VL_NORMAL').AsCurrency,ffFixed,10,2);
      //Preço Promoção
      Cells[4,I] := FloatToStrF( FieldByName('PRO_VL_PROMOCAO').AsCurrency,ffFixed,10,2);
      Inc(I);
      Next;
    end;
  end;
