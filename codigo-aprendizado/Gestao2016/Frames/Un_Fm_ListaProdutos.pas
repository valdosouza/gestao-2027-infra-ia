...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.DBCtrls, Vcl.Buttons, Vcl.StdCtrls, Vcl.Mask, RN_Produto, Un_Sistema, RN_Permissao, Un_Pesq_Produto;
...
begin
  ...
  Begin
    ...
    E_Busca_Produto.Text := Lc_Form.Qr_Pesquisa.FieldByName('PRO_DESCRICAO').AsString;
