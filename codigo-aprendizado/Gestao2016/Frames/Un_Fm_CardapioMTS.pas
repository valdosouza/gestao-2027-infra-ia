...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Un_Fm_CardapioMT, Data.DB, Vcl.Menus, ControllerMedida;
...
uses     Un_Msg, ControllerCardapio, sea_button_image, Un_CardapioProduto, env;
...
Var
  Lc_Produto : String;
  Form : TSeaButtonImage;
begin
  Form := TSeaButtonImage.create(Self);
  Try
    with Form do
    Begin
      ShowModal;
      if (Form.cds_searchcodigo.AsInteger > 0) then
      Begin
        with Fm_CardapioMT do
        Begin
          ...
          Begin
            AdiconaBotao(Lc_Produto,
                              GRupo,
                              SubGRupo,
                              Form.cds_searchcodigo.AsInteger,
                              Form.cds_searchSequencia.AsInteger)
          End;
        End;
      End;
    End;
