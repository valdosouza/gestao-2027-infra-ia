...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Mask, QEdit_Setes, Vcl.DBCtrls, Vcl.Buttons, Data.DB, STQuery,
...
uses     reg_plano_contas, Un_DM, RN_PlanoContas, UN_Sistema, UN_Principal, env;
...
Var
  Lc_Form : TRegPlanoContas;
begin
  Lc_Form := TRegPlanoContas.Create(nil);
  TRy
    Lc_Form.ShowModal;
    if FFiltrar then
      Pc_ListaParaFiltrar
      ...
      Pc_ListaParaUsar;
    E_Codigo_Plano.Text := Lc_Form.codigoRegistro.ToString;
