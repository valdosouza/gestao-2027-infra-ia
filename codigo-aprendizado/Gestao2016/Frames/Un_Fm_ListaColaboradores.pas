...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, STTransaction, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.DBCtrls, Vcl.Buttons, Vcl.StdCtrls, Data.DB, STQuery, Un_DM, STDatabase,
...
uses     sea_collaborator, RN_Permissao, Un_Regra_Negocio, UN_Sistema, UN_Principal, env ;
