...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.Grids, Vcl.StdCtrls, Vcl.Buttons, Vcl.ComCtrls, STQuery;
...
uses     Un_DM, Un_Msg, Un_Regra_Negocio, Un_PizzariaRecheios, RN_Pizzaria, RN_Itens_Vda_Avulso, RI_MovimentoFinanceiro, env;
      ...
      Begin
        ...
        Begin
          ...
          if (FieldByname('PRO_CAMPANHA').AsString = 'N') then
            Cells[Lc_J + 3,Lc_I] := FloatToStrF(FieldByname('PRO_VL_NORMAL').AsCurrency,ffFixed,10,2)
          else
            Cells[Lc_J + 3,Lc_I] := FloatToStrF(FieldByname('PRO_VL_PROMOCAO').AsCurrency,ffFixed,10,2);
          Lc_J := Lc_J + 3;
          next;
        end;
      end;
