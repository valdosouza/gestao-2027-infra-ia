object Fr_ProjLogChanges: TFr_ProjLogChanges
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Registro de Altera'#231#245'es no Sistema'
  ClientHeight = 529
  ClientWidth = 888
  Color = clBtnFace
  ...
  object WebBrowser: TWebBrowser
    ...
    ExplicitHeight = 542
    ControlData = {
      4C000000C75B0000AC3600000000000000000000000000000000000000000000
