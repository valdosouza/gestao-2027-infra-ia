inherited FrxOrderServiceEletcEquip: TFrxOrderServiceEletcEquip
  Caption = 'FrxOrderServiceEletcEquip'
  ClientHeight = 135
  ClientWidth = 307
  ExplicitWidth = 323
  ExplicitHeight = 174
  ...
  inherited frxBase: TfrxReport
    ReportOptions.LastChange = 44587.444356053200000000
    ScriptText.Strings = (
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo26: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '1- Hor'#195#161'rio de retirada - De segunda a sexta-feira das 08:30HS a' +
              's 18:45 hs, aos s'#225'bados das 08:30 as 14:00hs; '
            
              '2- Per'#195#173'odo para testes nos casos de instala'#195#167#195#163'o de sistema ope' +
              'racional, garantia '#195#169' de 7 dias; '
            
              '3- Produtos ser'#195#163'o testados no balc'#195#163'o, conferidos pelo cliente ' +
              'e garantia n'#195#163'o cobre mau uso; '
            
              '4- Equipamentos n'#195#163'o retirados no prazo de 90 dias ,ser'#195#163'o consi' +
              'derados como abandonados pelo cliente;'
            
              '5- N'#195#163'o nos responsabilizamos pelos dados de equipamentos que ch' +
              'egam com defeito f'#195#173'sico; '
            
              '6- **** EQUIPAMENTO N'#195#402'O SER'#195#129' RETIRADO SEM A ORDEM DE SERVI'#195#8225'O ' +
              '**** ')
          ParentFont = False
        end
        ...
        object frxDBaseReportDT_FORECAST: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[frxDBaseReport."DT_FORECAST"] -  [frxDBaseReport."HR_FORECAST"]')
          ParentFont = False
          WordWrap = False
        end
  ...
  inherited Qr_Consulta: TSTQuery
    SQL.Strings = (
      ...
      '  on (en.end_codemp = pe.ped_codend)'
