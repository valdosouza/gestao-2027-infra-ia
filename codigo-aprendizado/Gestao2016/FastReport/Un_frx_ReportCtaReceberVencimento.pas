unit Un_frx_ReportCtaReceberVencimento;

interface

uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, un_frx_ReportCtaReceber, Data.DB, STQuery, frxExportCSV, frxClass, frxExportPDF, frxDBSet, frxIBXComponents, Un_Funcoes, UN_Sistema, frxExportXLS;

type
  Tfrx_ReportCtaReceberVencimento = class(Tfrx_ReportCtaReceber)
...
var
  frx_ReportCtaReceberVencimento: Tfrx_ReportCtaReceberVencimento;
