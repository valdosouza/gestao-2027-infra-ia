inherited frx_ReportVendasBandeirasTEF: Tfrx_ReportVendasBandeirasTEF
  Caption = 'Vendas por Bandeiras TEF'
  PixelsPerInch = 96
  TextHeight = 13
  inherited frxBase: TfrxReport
    PrintOptions.PrintMode = pmSplit
    ReportOptions.LastChange = 44543.465461504600000000
    Datasets = <
      item
