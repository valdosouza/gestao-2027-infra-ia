...
uses
      Winapi.Windows, Winapi.Messages, base_registry, Vcl.StdCtrls, Vcl.Menus, Vcl.Controls, Vcl.Buttons, Classes, Vcl.ExtCtrls, Vcl.Mask, Vcl.DBCtrls, ControllerEspecieDoc, Data.DB, Vcl.Grids, Vcl.DBGrids, Vcl.Graphics, SysUtils;
