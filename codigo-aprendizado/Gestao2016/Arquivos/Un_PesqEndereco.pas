...
uses
      Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, DB, STQuery, StdCtrls, Buttons, Mask, Grids, DBGrids, ExtCtrls, DBCtrls, ComCtrls, XMLIntf, XMLDoc, acbrCep;
...
uses     UN_Sistema, Un_DM, UN_MSG, Un_Funcoes, Un_Regra_Negocio, UN_Principal, env;
    ...
    Begin
      ...
      Begin
        ...
        begin
          ...
          begin
            Cells[1,Lc_I + 1] := Cep;
            Cells[2,Lc_I + 1] := Upper(Tipo_Logradouro+ ' ' +Logradouro);
            Cells[3,Lc_I + 1] := Upper(Bairro);
            Cells[4,Lc_I + 1] := Upper(Municipio);
            Cells[5,Lc_I + 1] := Upper(UF);
          end ;
        end ;
      End;
    end;
