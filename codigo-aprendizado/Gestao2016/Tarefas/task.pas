...
type
  TTasOrderElectEquip1 = class(TBaseRegistry)
    CB_Device: TComboBox;
    Label1: TLabel;
    CB_Brand: TComboBox;
    Label2: TLabel;
...
var
  TasOrderElectEquip1: TTasOrderElectEquip1;
...
procedure TTasOrderElectEquip1.Cancel;
begin
  inherited;

end;

procedure TTasOrderElectEquip1.CancelAnnotation;
begin

end;

procedure TTasOrderElectEquip1.Change;
begin
  inherited;
  CB_Device.SetFocus;
...
procedure TTasOrderElectEquip1.CriarVariaveis;
begin
  inherited;
...
procedure TTasOrderElectEquip1.Dbg_ListAnnotationDblClick(Sender: TObject);
begin
  ShowDataAnotacao;
end;

procedure TTasOrderElectEquip1.Delete;
begin
  inherited;
  Conserto.delete;
  Close;
...
procedure TTasOrderElectEquip1.DeleteAnnotation;
begin
...
procedure TTasOrderElectEquip1.EditionControl;
begin
  inherited;
...
procedure TTasOrderElectEquip1.EditionControlAnnotation;
begin
...
procedure TTasOrderElectEquip1.Fm_ListaSituacaoDBLCB_SituacaoExit(
  Sender: TObject);
begin
...
procedure TTasOrderElectEquip1.GeraNumeroPedido;
begin
...
procedure TTasOrderElectEquip1.ImagemBotao;
begin
  inherited;
  CarregaImagemBotao(Sb_Imprimir,'IMPRIMIR');
end;

procedure TTasOrderElectEquip1.ImagemBotaoAnnotation;
begin
...
procedure TTasOrderElectEquip1.Imprimir;
Var
...
procedure TTasOrderElectEquip1.ImprimirOrdemServico;
Var
  Lc_Imp : TimpModImpressao;
Begin
  try
...
procedure TTasOrderElectEquip1.ImprimirTermoGarantia;
Var
  Lc_Imp : TimpModImpressao;
Begin
  try
...
procedure TTasOrderElectEquip1.IniciaVariaveis;
begin
...
procedure TTasOrderElectEquip1.Insert;
begin
  LimpaCampos;
  CB_Device.SetFocus;
  EditionStateAnnotation := 'B';
...
procedure TTasOrderElectEquip1.LimpaCampoAnotacao;
begin
...
procedure TTasOrderElectEquip1.LimpaCampos;
begin

end;

procedure TTasOrderElectEquip1.Save;
begin
  SaveEquipment;
  SaveOrder;
end;

procedure TTasOrderElectEquip1.SaveAnnotation;
begin
...
procedure TTasOrderElectEquip1.SaveEquipment;
Var
...
procedure TTasOrderElectEquip1.SaveOrder;
begin
  with Conserto do
  Begin
...
procedure TTasOrderElectEquip1.Sb_Alt_AnotacaoClick(Sender: TObject);
begin
...
procedure TTasOrderElectEquip1.Sb_Can_AnotacaoClick(Sender: TObject);
begin
...
procedure TTasOrderElectEquip1.Sb_Exc_AnotacaoClick(Sender: TObject);
begin
  inherited;
...
procedure TTasOrderElectEquip1.Sb_Grv_AnotacaoClick(Sender: TObject);
begin
...
procedure TTasOrderElectEquip1.Sb_ImprimirClick(Sender: TObject);
begin
  Imprimir;
end;

procedure TTasOrderElectEquip1.Sb_Ins_AnotacaoClick(Sender: TObject);
begin
...
procedure TTasOrderElectEquip1.Sb_Pesq_DeviceClick(Sender: TObject);
Var
...
procedure TTasOrderElectEquip1.setPerfil;
Var
  Lc_Menu : String;
begin
...
procedure TTasOrderElectEquip1.ShowData;
begin
  ShowDataConserto;
  ShowListDataAnotacao;
end;

procedure TTasOrderElectEquip1.ShowDataAnotacao;
begin
...
procedure TTasOrderElectEquip1.ShowListDataAnotacao;
Var
  I : Integer;
begin
  Conserto.Anotacao.Registro.Identificar := 'TB_ELECT_EQUIP';
...
procedure TTasOrderElectEquip1.ShowDataConserto;
begin
  with Conserto do
  Begin
...
procedure TTasOrderElectEquip1.ShowDataEquipamento;
begin
  with Conserto.Equipamento do
  Begin
...
function TTasOrderElectEquip1.validaDeleteAnnotation: Boolean;
begin
  Result := True;
...
function TTasOrderElectEquip1.validaEditAnnotation: Boolean;
begin
  Result := True;
  if not validaAnnotationHasItem then
  Begin
...
function TTasOrderElectEquip1.ValidaImprimir: Boolean;
begin
  REsult := True;
end;

function TTasOrderElectEquip1.ValidaImprimirOrdemServico: Boolean;
begin
  REsult := True;
end;

function TTasOrderElectEquip1.ValidaImprimirTermoGarantia: Boolean;
begin
  REsult := True;
  if Fm_ListaTecnico.Dblcb_Vendedor.Text = '' then
  Begin
...
function TTasOrderElectEquip1.validaAnnotationHasItem: Boolean;
begin
  Result := True;
...
function TTasOrderElectEquip1.validaCancelAnnotation: Boolean;
begin
  Result := True;
end;

function TTasOrderElectEquip1.validaInsertAnnotation: Boolean;
begin
  Result := True;
...
function TTasOrderElectEquip1.validaSaveAnnotation: Boolean;
begin
  REsult := True;
...
function TTasOrderElectEquip1.ValidateCancel: Boolean;
begin
  REsult := True;
end;

function TTasOrderElectEquip1.ValidateChange: Boolean;
begin
  Result := True;
end;

function TTasOrderElectEquip1.ValidateDelete: boolean;
begin
  Result := True;
  //quando a pergunta esta dentro da validação verifica-se o botão da negativa
  if (MensagemPadrao(TITULO_CONFIRMACAO,
...
function TTasOrderElectEquip1.ValidateSave: Boolean;
Var
  Lc_Escolha : Integer;
begin
  REsult := True;
