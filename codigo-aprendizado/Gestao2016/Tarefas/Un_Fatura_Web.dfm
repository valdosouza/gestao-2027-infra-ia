object Fr_Fatura_Web: TFr_Fatura_Web
  Left = 611
  Top = 105
  ...
  object Qr_Pedido: TSTQuery
    ...
    SQL.Strings = (
      ...
      '  PED_DATA, '
      '  PED_VL_PRODUTO, '
      '  (PGE_VL_TOTAL - PED_VL_PEDIDO) PED_VL_ODESPESA, '
      '  PED_VL_IPI, '
      '  PED_VL_FRETE, '
      '  PED_VL_DESCONTO, '
      '  PED_NUMERO,'
      ...
      '   INNER JOIN TB_PAG_ELETRONICO tb_pag_eletronico'
      '  ON (tb_pag_eletronico.PGE_CODPED = tb_pedido.PED_NUMERO)'
