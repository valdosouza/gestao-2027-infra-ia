...
uses
      STDatabase, Data.DB, Classes, STQuery, STTransaction, FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
  FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt,
  FireDAC.Comp.Client, FireDAC.Comp.DataSet, IBX.IBDatabase,
...
Var
  ...
  Lc_SqlTxt: StriNg;
begin
  Lc_Inst_Vend := (Fc_Aq_Geral('L', 'ORDEM DE SERVICO', 'OSR_P_INSTALA_VENDE',
      'N') = 'S');
