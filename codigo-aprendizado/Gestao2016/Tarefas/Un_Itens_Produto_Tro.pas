...
type
  TFr_Itens_Produto_Tro = class(TFr_Itens_Produto)
  private
...
var
  Fr_Itens_Produto_Tro: TFr_Itens_Produto_Tro;
...
{ TFr_Itens_Produto_Tro }

function TFr_Itens_Produto_Tro.grava:boolean;
Var
  Lc_Estoque : String;
Begin
  if Fc_ExisteItemNoPedido('T') then
  Begin
...
procedure TFr_Itens_Produto_Tro.Pc_formatatela;
begin
  inherited;
  tbs_tributacao.TabVisible := False;
end;

procedure TFr_Itens_Produto_Tro.Pc_StateChange(Pc_Tipo: integer);
begin
  inherited;
  case Pc_Tipo of
    2:Begin //Inserindo
...
function TFr_Itens_Produto_Tro.validaGravacao: Boolean;
begin
  Result := True;
