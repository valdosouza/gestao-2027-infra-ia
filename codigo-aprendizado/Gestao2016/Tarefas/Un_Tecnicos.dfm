object Fr_Tecnicos: TFr_Tecnicos
  Left = 604
  Top = 131
  Anchors = [akLeft, akTop, akRight, akBottom]
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Rela'#231#227'o de T'#233'cnicos que executaram o servi'#231'o'
  ClientHeight = 356
  ClientWidth = 517
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object SB_Cofirmar: TSpeedButton
      Left = 343
      Top = 298
      Width = 85
      Height = 54
    ...
    object StrGrd_Tecnico: TStringGrid
      Left = 3
      Top = 4
      Width = 511
      Height = 288
      ...
      ScrollBars = ssNone
      TabOrder = 0
      OnDblClick = StrGrd_TecnicoDblClick
      OnDrawCell = StrGrd_TecnicoDrawCell
      OnSelectCell = StrGrd_TecnicoSelectCell
      ColWidths = (
        40
        40
        40
  ...
  object Qr_Todos: TSTQuery
    ...
    SQL.Strings = (
      ...
      'AND (CRG_DESCRICAO LIKE '#39'%CNICO%'#39
      '          OR CRG_DESCRICAO LIKE '#39'%MEC%NICO%'#39
      '          OR CRG_DESCRICAO LIKE '#39'%INSTALAD%'#39' )')
    Left = 88
    Top = 120
  end
