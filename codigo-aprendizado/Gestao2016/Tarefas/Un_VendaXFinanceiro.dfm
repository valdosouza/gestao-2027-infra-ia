object Fr_VendaXFinanceiro: TFr_VendaXFinanceiro
  Left = 145
  Top = 99
  Caption = 'An'#225'lise de Vendas e Financeiro'
  ClientHeight = 462
  ClientWidth = 872
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object ChBx_Suprimir: TCheckBox
      Left = 8
      Top = 96
      Width = 165
      Height = 17
      Caption = 'Suprimir os Saldo Zeros'
      TabOrder = 7
      OnClick = ChBx_SuprimirClick
    end
  end
  object StrGrd_Vendas: TStringGrid
    ...
    ParentFont = False
    TabOrder = 1
    OnDrawCell = StrGrd_VendasDrawCell
    ColWidths = (
      40
      40
      40
  ...
  object Qr_Financeiro: TSTQuery
    ...
    SQL.Strings = (
        ...
        'SELECT FIN_CODIGO,FIN_NUMERO,FIN_DT_VENCIMENTO, FIN_VL_PARCELA, ' +
        'FIN_DT_PAGTO, FIN_VL_PAGO, FIN_OPERACAO '
