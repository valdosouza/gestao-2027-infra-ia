...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_registry, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.Mask, Vcl.DBCtrls, controllersalesorigin;
...
begin
  ...
  Begin
    salesOrigin.Registro.id := Self.CodigoRegistro;
    salesOrigin.getbyId;
  End;
  inherited;
end;
...
begin
  with salesOrigin do
  Begin
    Registro.Description := E_Descricao.Text;
    salva;
  End;
  CodigoRegistro := salesOrigin.Registro.id;
  inherited;
end;
...
begin
  with salesOrigin do
  Begin
    E_Codigo.Text     := Registro.id.ToString;
    E_Descricao.Text  := Registro.Description;
  End;
  inherited;
end;
