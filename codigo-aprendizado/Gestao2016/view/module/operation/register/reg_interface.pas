...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, Vcl.DBCtrls, Vcl.StdCtrls, Vcl.CheckLst, Vcl.Mask, System.StrUtils, base_registry, ControllerInterface;
...
uses     UN_MSG, UnFunctions, env, Un_Funcoes;
...
begin
  ...
  cInterface.Registro.Formulario := E_FormName.Text;
  cInterface.Registro.CodigoMenu := cInterface.menus.getCodigoLista(cb_Menu.Text);
...
begin
  ...
  E_FormName.Text := cInterface.Registro.Formulario;
  Lc_Aux := cInterface.menus.getDescLista(cInterface.Registro.CodigoMenu);
