...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_search, Data.DB, Datasnap.Provider, Datasnap.DBClient, Vcl.Menus, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, Vcl.ExtCtrls, ControllerBotao;
...
type
  TSeaButtonImage = class(TBaseSearch)
    ...
    cds_searchSequencia: TIntegerField;
  protected
...
begin
  ...
  for i := 0 to Pred(botao.Lista.Count) do
    cds_search.AppendRecord([botao.Lista[i].Codigo, botao.Lista[i].Descricao, botao.Lista[i].Sequencia]);
