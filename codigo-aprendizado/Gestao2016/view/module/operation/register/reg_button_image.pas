...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_registry, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.ComCtrls, Vcl.Mask, Vcl.DBCtrls, ControllerBotao, Vcl.Samples.Spin;
...
type
  TRegButtonImage = class(TBaseRegistry)
    ...
    procedure Sb_AmostraClick(Sender: TObject);
    procedure E_LabelChange(Sender: TObject);
  private
...
procedure TRegButtonImage.E_LabelChange(Sender: TObject);
begin
...
procedure TRegButtonImage.Sb_AmostraClick(Sender: TObject);
begin
  Pc_MontaImagemBotao;
end;
...
procedure TRegButtonImage.setPerfil;
begin
  pfMenu := 'Botão';
  inherited;
end;
