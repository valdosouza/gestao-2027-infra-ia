...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_registry, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, Vcl.DBCtrls, Vcl.StdCtrls, Vcl.Mask, ControllerMarcaProduto, Un_Fm_ListaEmpresas, Un_Fm_ListaFornecedores;
...
begin
  ...
  Begin
    ...
    if Fm_ListaFornecedores1.DBLCB_Empresa.Text <> '' then
...
begin
  ...
  marcaProduto.registro.Codigo    := StrToIntDef(E_Codigo.Text,0);
