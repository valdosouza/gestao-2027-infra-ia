...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_search, Data.DB, Datasnap.DBClient, Vcl.Menus, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, Vcl.ExtCtrls, ControllerVehicleBrand, Datasnap.Provider;
...
type
  TSeaVehicleBrand = class(TBaseSearch)
    ...
    cds_searchCodigoModelo: TIntegerField;
...
begin
  ...
  for i := 0 to Pred(vehicleBrand.Lista.Count) do
    cds_search.AppendRecord([vehicleBrand.Lista[i].Codigo,
                             vehicleBrand.Lista[i].Descricao,
                             vehicleBrand.Lista[i].ModeloDescricao,
                             vehicleBrand.Lista[i].CodigoModelo
                             ]);

  cds_search.EnableControls;
end;

procedure TSeaVehicleBrand.setPerfil;
begin
