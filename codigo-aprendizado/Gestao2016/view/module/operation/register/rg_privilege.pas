//Manter o Estabelecimento como zero por que a permissao do usuario eh para todas as empresas
unit rg_privilege;
...
uses
      STQuery, Data.DB, Vcl.DBCtrls, ControllerPermission, Vcl.StdCtrls, Vcl.ComCtrls, Vcl.Buttons, Vcl.Controls, Classes, Un_Base, Vcl.ExtCtrls, Vcl.Forms, SysUtils, Vcl.Graphics, Winapi.Messages, Winapi.Windows, STStoredProc, Vcl.Grids, Vcl.DBGrids, Vcl.CheckLst, Vcl.Dialogs, Vcl.Menus;
...
uses     Un_Msg, Un_DM, env, unFunctions, Un_Funcoes;
{$R *.dfm}
...
begin
  ...
  begin
    ...
    begin
      case FAcesso of
        1:Begin
            Permissao.Registro.Estabelecimento := 0;
  ...
  begin
    ...
    case FAcesso of
      1:begin
          ...
          Permissao.Parametros.Estabelecimento := 0;
