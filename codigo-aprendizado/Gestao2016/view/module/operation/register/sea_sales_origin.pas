...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_search, Data.DB, Datasnap.Provider, Datasnap.DBClient, Vcl.Menus, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, Vcl.ExtCtrls, controllersalesorigin;
...
begin
  ...
  salesorigin.Parametros.FieldName.id := StrToIntDef(E_BuscaCodigo.Text, 0);
  salesorigin.Parametros.FieldName.Description := E_BuscaDescricao.Text;
  ...
  for i := 0 to Pred(salesorigin.Lista.Count) do
    cds_search.AppendRecord([salesorigin.Lista[i].id, salesorigin.Lista[i].Description]);
