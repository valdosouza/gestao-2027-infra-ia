...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_registry, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.Mask, Vcl.DBCtrls, ControllerEstoques, Data.DB, STQuery, System.StrUtils;
...
begin
  ...
  Begin
    ...
    Registro.Principal := IfThen(ChBx_Estoque.Checked,'S','N');
    salva;
  End;
...
begin
  ...
  Begin
    ...
    ChBx_Estoque.Checked := Registro.Principal = 'S';
 End;
  inherited;
end;
...
begin
  ...
  begin
    ...
    begin
      try
        stocks.CriaRegistroEstoque(Self.CodigoRegistro);
      except
        MensagemPadrao(TITULO_ERRO,ATENCAO+EOLN+EOLN+
