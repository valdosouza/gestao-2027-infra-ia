...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, base_search, Data.DB, Vcl.StdCtrls, Datasnap.DBClient, Vcl.Menus, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.ExtCtrls, ControllerContato, Datasnap.Provider;
...
begin
  ...
  Try
    ...
    Lc_form.CodigoVinculo := FCodigoVinculo;
    Lc_form.ShowModal;
  Finally
    FreeAndNil(Lc_form);
  End;
...
procedure TSeaContacts.setFCodigoVinculo(const Value: Integer);
begin
