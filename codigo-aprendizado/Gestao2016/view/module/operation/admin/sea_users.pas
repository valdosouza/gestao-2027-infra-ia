...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Data.DB, Vcl.StdCtrls, Datasnap.DBClient, Vcl.Menus, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.ExtCtrls, ControllerUsuario, base_search, Datasnap.Provider;
...
begin
  ...
  if ChBx_Inativos.Checked then
    users.Parametros.FieldName.Ativo := 'N'
  else
    users.Parametros.FieldName.Ativo := 'S';
