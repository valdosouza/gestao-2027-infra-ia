...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Menus, Vcl.Buttons, Vcl.ExtCtrls, System.StrUtils, base_registry, ControllerImpressora;
...
begin
  ...
  Begin
    ...
    Registro.Tipo := IfThen(Ch_Tipo.Checked, SIGLA_S, SIGLA_N);
    salva;
  End;
