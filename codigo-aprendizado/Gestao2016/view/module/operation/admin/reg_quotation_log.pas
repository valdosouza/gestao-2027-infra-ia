...
uses
      Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Un_Base, Vcl.Menus, Vcl.StdCtrls, Vcl.ComCtrls, Vcl.Mask, Vcl.ExtCtrls, Data.DB, Vcl.Grids, Vcl.DBGrids, Vcl.Buttons, ControllerCotacao, Datasnap.DBClient;
...
type
  TRegQuotationLog = class(TFr_Base)
    ...
    mem_searchItens: TClientDataSet;
    ds_searchItens: TDataSource;
    mem_search: TClientDataSet;
...
uses     UN_Sistema, UN_MSG, Un_Fc_Sored_Procedures, env;
  ...
  begin
    try
      ...
      MensagemPadrao('Mensagem de erro','A T E N Ç Ã O!.'+EOLN+EOLN+
                     'Um erro impossibilitou a operção.'+EOLN+
