...
uses
      Winapi.Windows, Winapi.Messages, SysUtils, Variants, Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Un_base, Data.DB, Datasnap.Provider, Datasnap.DBClient, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.ComCtrls, Vcl.ExtCtrls, Vcl.Menus, Vcl.StdCtrls, STQuery, Un_DM, System.UITypes;
...
type
  ...
  protected
    ...
    //Transição de Formas de herança
    SelectTxt : String;
    InnerJoinTxt : String;
    WhereTxt : String;
