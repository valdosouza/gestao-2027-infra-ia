...
Type
  ...
  TDskSyncTable = Class(TGenericEntity)
  private
    FTM_UPDATE: TTime;
    FID: String;
    FOPERATOR: Integer;
...
procedure TDskSyncTable.setFDT_UPDATE(const Value: TDAte);
begin
  FDT_UPDATE := Value;
end;

procedure TDskSyncTable.setFID(const Value: String);
begin
  FID := Value;
end;

procedure TDskSyncTable.setFKIND(const Value: String);
begin
  FKIND := Value;
end;

procedure TDskSyncTable.setFOPERATOR(const Value: Integer);
begin
  FOPERATOR := Value;
end;

procedure TDskSyncTable.setFTM_UPDATE(const Value: TTime);
begin
  FTM_UPDATE := Value;
end;

procedure TDskSyncTable.setFWAY(const Value: String);
begin
  FWAY := Value;
end;
