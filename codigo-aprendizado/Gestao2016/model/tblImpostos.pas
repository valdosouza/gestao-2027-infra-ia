...
Type
  ...
  private
    ...
    procedure setFIPT_DT_ALT(const Value: TDateTime);
  ...
  public
    ...
    property DtAlt: TDateTime read FIPT_DT_ALT write setFIPT_DT_ALT;
...
procedure TImpostos.setFIPT_DT_ALT(const Value: TDateTime);
begin
  FIPT_DT_ALT := Value;
end;
