...
Type
  ...
  private
    ...
    procedure setFICM_BCFCPST(const Value: Real);
    procedure setFICM_PFCPST(const Value: Real);
    procedure setFICM_VFCPST(const Value: Real);
    procedure setFICM_AQ_DIF(const Value: Real);
    procedure setFICM_VL_DIF(const Value: Real);
  ...
  public
    ...
    [FieldName('ICM_BCFCPST')]
    property BaseFCPST: Real read FICM_BCFCPST write setFICM_BCFCPST;

    [FieldName('ICM_PFCPST')]
    property AliqFCPST: Real read FICM_PFCPST write setFICM_PFCPST;

    [FieldName('ICM_VFCPST')]
    property ValorFCPST: Real read FICM_VFCPST write setFICM_VFCPST;

    [FieldName('ICM_AQ_DIF')]
    property AliquotaDiferido: Real read FICM_AQ_DIF write setFICM_AQ_DIF;

    [FieldName('ICM_VL_DIF')]
    property ValorDiferido: Real read FICM_VL_DIF write setFICM_VL_DIF;
...
procedure TItensIcms.setFICM_AQ_DIF(const Value: Real);
begin
  FICM_AQ_DIF := Value;
end;
...
procedure TItensIcms.setFICM_BCFCPST(const Value: Real);
begin
  FICM_BCFCPST := Value;
end;
...
procedure TItensIcms.setFICM_PFCPST(const Value: Real);
begin
  FICM_PFCPST := Value;
end;
...
procedure TItensIcms.setFICM_VFCPST(const Value: Real);
begin
  FICM_VFCPST := Value;
end;
...
procedure TItensIcms.setFICM_VL_DIF(const Value: Real);
begin
  FICM_VL_DIF := Value;
end;
