...
Type
  ...
  private
    ...
    procedure setFPRO_QTDE_MIN_AUTO_REPO(const Value: Real);
  ...
  public
    ...
    [FieldName('PRO_QTDE_MIN_AUTO_REPO')]
    property QtdeMinAutoReposicao: Real read FPRO_QTDE_MIN_AUTO_REPO write setFPRO_QTDE_MIN_AUTO_REPO;
...
procedure TProduto.setFPrecoVenda(const Value: Real);
begin
  FPrecoVenda := Value;
end;
...
procedure TProduto.setFPRO_QTDE_MIN_AUTO_REPO(const Value: Real);
begin
  FPRO_QTDE_MIN_AUTO_REPO := Value;
end;
