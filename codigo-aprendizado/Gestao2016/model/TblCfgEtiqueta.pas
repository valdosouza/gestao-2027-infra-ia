...
Type
  ...
  private
    ...
    procedure setFcge_typefone(const Value: String);
  ...
  public
    ...
    property TypeFonte: string read Fcge_typefonte write setFcge_typefone;
...
procedure TCfgEtiqueta.setFcge_typefone(const Value: string);
begin
