...
Type
  ...
  private
    ...
    procedure setFFormatoDiscr(const Value: String);
    procedure setFCodigoNBS(const Value: String);
  ...
  public
    ...
    [FieldName('NFS_FORMATODISCR')]
    property FormatoDiscr: String read FFormatoDiscr write setFFormatoDiscr;

    [FieldName('NFS_CODIGONBS')]
    property CodigoNBS: String read FCodigoNBS write setFCodigoNBS;
...
procedure TNFSEletronica.setFCodigoNBS(const Value: String);
begin
  FCodigoNBS := Value;
end;
...
procedure TNFSEletronica.setFFormatoDiscr(const Value: String);
begin
  FFormatoDiscr := Value;
end;
