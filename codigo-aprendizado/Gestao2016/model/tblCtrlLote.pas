...
Type
  ...
  private
    ...
    procedure setFCLT_CODEST(const Value: Integer);
  ...
  public
    ...
    [FieldName('CLT_CODEST')]
    property Estoque : Integer read FCLT_CODEST write setFCLT_CODEST;
...
procedure TCtrlLote.setFCLT_CODEST(const Value: Integer);
begin
  FCLT_CODEST := Value;
end;
