...
Type
  ...
  private
    ...
    procedure setFDestino(const Value: String);
    procedure setFSaldo(const Value: Real);
  ...
  public
    ...
    property Destino : String read FDestino write setFDestino;

    property Saldo : Real Read FSaldo write setFSaldo;
  End;
...
procedure TCheque.setFDestino(const Value: String);
begin
  FDestino := Value;
end;

procedure TCheque.setFNomeCliente(const Value: String);
begin
  FNomeCliente := Value;
end;

procedure TCheque.setFSaldo(const Value: Real);
begin
  FSaldo := Value;
end;
