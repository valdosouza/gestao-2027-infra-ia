...
type
  [TableName('TB_TAXES_IBS_UF')]
  TTaxesIbsUf = class(TGenericEntity)
  private
...
procedure TTaxesIbsUf.CreateTable;
begin
  inherited;

end;

procedure TTaxesIbsUf.Setaliquota(const Value: Real);
begin
  Faliquota := Value;
end;

procedure TTaxesIbsUf.Setaliq_dif(const Value: Real);
begin
  Faliq_dif := Value;
end;

procedure TTaxesIbsUf.Setaliq_efe(const Value: Real);
begin
  Faliq_efe := Value;
end;

procedure TTaxesIbsUf.Setaliq_red(const Value: Real);
begin
  Faliq_red := Value;
end;

procedure TTaxesIbsUf.Settb_taxes_id(const Value: Integer);
begin
  Ftb_taxes_id := Value;
end;
