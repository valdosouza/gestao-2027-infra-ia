...
Type
  ...
  private
    ...
    procedure setFSentidoCFOP(const Value: String);
    procedure setFTRB_CODEMP(const Value: Integer);
    procedure setFTRB_AQ_DIF(const Value: Real);
    procedure setFTB_TAXES_ID(const Value: Integer);
  ...
  public
    ...
    property SentidoRegra: String  read FTRB_SENTIDO write setFTRB_SENTIDO;

    [FieldName('TRB_CODEMP')]
    property Empresa: Integer  read FTRB_CODEMP write setFTRB_CODEMP;

    [FieldName('TRB_AQ_DIF')]
    property AliquotaDiferida: Real  read FTRB_AQ_DIF write setFTRB_AQ_DIF;

    [FieldName('TB_TAXES_ID')]
    property CodigoTaxas: Integer read FTB_TAXES_ID write setFTB_TAXES_ID;


    property NAT_CFOP: String read FNAT_CFOP write setFNAT_CFOP;
    property SentidoCFOP : String read FSentidoCFOP write setFSentidoCFOP;
...
procedure TTributacao.CreateField;
begin
  if not existField('TB_TRIBUTACAO','TB_TAXES_ID') then
  Begin
    RunScript('ALTER TABLE TB_TRIBUTACAO ADD TB_TAXES_ID INTEGER;');
  End;
...
procedure TTributacao.setFSentidoCFOP(const Value: String);
begin
  FSentidoCFOP := Value;
end;

procedure TTributacao.setFTB_TAXES_ID(const Value: Integer);
begin
  FTB_TAXES_ID := Value;
end;
...
procedure TTributacao.setFTRB_AQ_DIF(const Value: Real);
begin
  FTRB_AQ_DIF := Value;
end;
...
procedure TTributacao.setFTRB_CODEMP(const Value: Integer);
begin
  FTRB_CODEMP := Value;
end;
