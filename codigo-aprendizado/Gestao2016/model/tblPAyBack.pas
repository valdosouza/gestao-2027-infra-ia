...
Type
  ...
  private
    ...
    procedure setFDT_EXPIRE(const Value: TDate);
  ...
  public
    ...
    [FieldName('DT_EXPIRE')]
    property DataExpira: TDate read FDT_EXPIRE write setFDT_EXPIRE;
...
procedure TPayBack.setFDT_EXPIRE(const Value: TDate);
begin
  FDT_EXPIRE := Value;
end;
...
procedure TPayBack.setFSTATUS(const Value: String);
begin
  FSTATUS := Value;
end;
