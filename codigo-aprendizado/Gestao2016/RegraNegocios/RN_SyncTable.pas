...
begin
  Try
    ...
    Begin
      ...
      ParamByName('OPERATOR').AsString :=  operador;
      ParamByName('dt_update').AsString := Lc_St_data;
      ParamByName('tm_update').AsString := Lc_St_Time;
      ExecSQL;
      Result := Id;
    End;
  Finally
  ...
  Try
    ...
    Begin
      ...
      Begin
        ...
        Lc_Data := FieldByname('dt_update').AsString;
        Lc_Data := Copy(Lc_Data,7,4) + '-' + Copy(Lc_Data,4,2) + '-' + Copy(Lc_Data,1,2);
        Lc_DataTime := Lc_Data + ' ' + FieldByname('tm_update').AsString;
      end
      else
      Begin
