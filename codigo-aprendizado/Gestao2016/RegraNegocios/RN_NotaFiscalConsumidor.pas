...
uses
      Forms, Controls, SysUtils, STQuery, STStoredProc, STDatabase, StdCtrls, classes, db, System.Math, ControllerNotaFiscal;

  procedure Pc_AbreTelaPesqNF_65;
  procedure Pc_AbreTelaNotaFiscal65(Tipo:String;PC_Codigo:Integer);
implementation

uses     Un_DM, UN_Sistema, UN_MSG, un_Padrao, Un_Fc_Sored_Procedures, Un_Pesq_NF_Pro, Un_NF_65;
