...
uses     System.Classes, System.SysUtils, ACBrTEFD, ACBrTEFDClass, Vcl.Dialogs, Un_Sistema, Vcl.StdCtrls;
...
begin
  ...
  Begin
    ...
    begin
      ...
      Lines.Add('Resultado  : Transção aprovada.');
    end
    else
    begin
      Lines.Add('Resultado  : Transção Negada.');
      Exit;
    end;
  end;
end;
