...
//-------------------------Controle de Inventario ----------------------------------------------
  ...
  Function  Fc_ValidaDataPedido(Fc_Data:Tdate):Boolean;
var
    It_Cd_Inventario : Integer;

    It_Qt_Anterior : Real;
    It_Qt_Ent_Compra : Real;
    It_VL_Ent_Compra: Currency;

    It_Qt_Ent_Outra : Real;
    It_VL_Ent_Outra: Currency;

    It_Vl_Sai_Venda: Currency;
    It_Qt_Sai_Venda  : Real;

    It_VL_Sai_Outra: Currency;
    It_Qt_Sai_Outra : Real;
    It_Vl_Custo_Ant: Currency;
...
begin
  Try
    ...
    Begin
      ...
      ParamByName('PED_TIPO').AsString := '2';
      ParamByName('NFL_TIPO').AsString := 'E%';
      Active := True;
      It_Qt_Ent_Compra := FieldByName('ITF_QT_TOTAL').AsCurrency;
      It_VL_Ent_Compra := FieldByName('ITF_SUBTOTAL').AsCurrency + FieldByName('ITF_VL_IPI').AsCurrency;
      ...
      ParamByName('DATAINI').AsDate := Pc_Dt_Ini;
      ParamByName('DATAFIM').AsDate := Pc_Dt_Fim;
      ParamByName('PED_TIPO').AsString := '3';
      ParamByName('NFL_TIPO').AsString := 'E%';
      Active := True;
      It_Qt_Ent_Outra := FieldByName('ITF_QT_TOTAL').AsCurrency;
      It_VL_Ent_Outra := FieldByName('ITF_SUBTOTAL').AsCurrency + FieldByName('ITF_VL_IPI').AsCurrency;
      ...
      ParamByName('DATAINI').AsDate := Pc_Dt_Ini;
      ParamByName('DATAFIM').AsDate := Pc_Dt_Fim;
      ParamByName('PED_TIPO').AsString := '1';
      ParamByName('NFL_TIPO').AsString := 'S%';
      Active := True;
      It_Qt_Sai_Venda := FieldByName('ITF_QT_TOTAL').AsCurrency;
      It_Vl_Sai_Venda := FieldByName('ITF_SUBTOTAL').AsCurrency + FieldByName('ITF_VL_IPI').AsCurrency;
      ...
      ParamByName('NFL_TIPO').AsString := 'S%';
      Active := True;
      It_Qt_Sai_Outra := FieldByName('ITF_QT_TOTAL').AsCurrency;
      It_Vl_Sai_Outra := FieldByName('ITF_SUBTOTAL').AsCurrency + FieldByName('ITF_VL_IPI').AsCurrency;
    end;
  Finally
    LcBase.FinalizaQuery(Lc_Qry);
    FreeAndNil(LcBase);
...
Begin
  Result:=TRUE;
  //Verifica Inventario
  Lc_Dt_Inventario := Fc_UltimaDataInventario();
