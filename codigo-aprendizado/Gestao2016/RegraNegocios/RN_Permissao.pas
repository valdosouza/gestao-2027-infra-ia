...
uses
      Un_DM, UN_MSG, un_Padrao, Un_Fc_Sored_Procedures, STQuery, SysUtils, MD5, ControllerUsuario, ControllerColaborador;
...
uses     UN_Principal, env, Un_Funcoes, ControllerBase;
Function Fc_VerificaPermissao(Fc_Interface,Fc_Descricao,Fc_Privilegio:String;Fc_cd_Usuario:Integer;Fc_Msg:String):Boolean;
var
  Lc_Qry: TSTQuery;
  Lc_SqlTxt: string;
...
begin
  ...
  Lc_Colab := TControllerColaborador.create(nil);
  Try
    ...
    Begin
      ...
      Lc_Colab.Registro.USuario := Lc_Usuario.Registro.Codigo;
      Lc_Colab.GetByUser;
      if Lc_Colab.exist then
      Begin
        Gb_Cd_Vendedor := Lc_Colab.Registro.Codigo;
      end;
