...
Begin
  ...
  with Lc_Qry do
    ...
    ParamByName('identify').AsString :=  identify;
    ParamByName('dt_record').AsString :=  dt_record;
    ParamByName('link_id1').AsString :=  link_id1;
    ParamByName('link_id2').AsString :=  link_id2;
    ParamByName('reference').AsString := reference;
    ParamByName('observation').AsString := observation;
