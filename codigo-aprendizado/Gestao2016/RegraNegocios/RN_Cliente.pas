...
uses     Un_DM, UN_Sistema, UN_MSG, un_Padrao, Un_Regra_Negocio, RN_Endereco, RN_Crud, Un_Funcoes, UN_TabelasEmListas, Un_Cliente, ControllerBase, ControllerFormaPagamento, env;
function Fc_InsereClienteAuto(Fc_CODEMP:String):Integer;
Var
  Lc_Qry : TSTQuery;
