...
uses
      Forms, Controls, SysUtils, STQuery, STStoredProc, STDatabase, StdCtrls, classes, db, ControllerFormaPagamento;
   ...
   function Fc_AbreTelaFormaPagto(Pc_Codigo:Integer):Integer;
...
uses     Un_DM, UN_Sistema, UN_MSG, un_Padrao, Un_Regra_Negocio, UN_FormaPagto, ControllerBase;
function Fc_PegaParteFormaPgto(Fc_Descricao: String): Integer;
var
...
begin
  try
    ...
    Lc_Form.It_Cd_FormaPAgto := Pc_Codigo;
    Lc_Form.ShowModal;
    Result := TFr_FormaPagto(Lc_Form).It_Cd_FormaPAgto;
  finally
    FreeAndNil(Lc_Form);
  end;
