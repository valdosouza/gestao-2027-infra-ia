...
uses
      STDatabase, STQuery, SysUtils, ACBrValidador, STTransaction, Vcl.Samples.Gauges, Vcl.StdCtrls, Vcl.DBCtrls, Vcl.Forms;
...
{----------------------------------------}
  ...
  procedure Pc_AtualizaUltimaMovimentacao(Periodo:Boolean;Pc_Data_Ini,Pc_Data_Fim:TDateTime;Pc_Progresso:TGAuge);
...
uses     Un_DM, UN_Sistema, UN_MSG, un_Padrao, Un_Regra_Negocio, RN_NotaFiscalEletronica3X, Un_Funcoes, RN_Crud, Un_Pesq_Empresa, UN_TabelasEmListas, Un_Empresa, RN_Cliente, RN_Fornecedor, RN_Transportadora, ControllerEmpresa, ControllerBase, env;
function Fc_BuscaCodigoEmpresa(FcDataBase : TSTDatabase;
                               FcTransaction : TSTTransaction;
                               Fc_CNPJ: String): Integer;
Var
  ...
  Begin
    ...
    Begin
      ...
      Begin
        ...
        Lc_Aux := Fc_RemoveCaracterInformado(FieldByName('EMP_INSC_EST').AsString,['.',',','/','-']);
