...
Begin
  ...
  Begin
    ...
    ParamByName('TB_ITENSNLF_ID').AsString := tb_itensnlf_id;
    ParamByName('TB_PEDIDO_ID').AsString := tb_pedido_iD;
    ParamByName('TB_KIND_LUCRATIVIDADE_ID').AsString :=  tb_kind_lucratividade_id;
    ParamByName('OPERATION').AsString := operation;
