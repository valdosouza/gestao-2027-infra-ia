...
uses     Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, ExtCtrls, Buttons, ComCtrls, OleCtrls, SHDocVw, IniFiles, DB, STQuery, Grids, DBGrids, Menus, Mask, Printers, ACBrNFeDANFeESCPOS, ACBrNFe, pcnConversao, ACBrNFeDANFEClass, pcnLeitor, blcksock, ACBrDFeSSL, ACBrNFeNotasFiscais, ACBrNFeWebServices, pcnConversaoNFe, ACBrNFeDANFeRLClass, QuickRpt, ACBrPosPrinter, ControllerBase, FavoritoButtons, Gauges, STDatabase, ACBrValidador;
...
uses     Un_DM, UN_Sistema, UN_MSG, un_Padrao, Un_Funcoes, Un_Fc_Sored_Procedures, Un_Pesq_Nf_Srv, Un_NF_SRV, un_geranfe_Srv, Un_Regra_Negocio, UN_Principal, env, RN_Mailing, Un_envia_email;
procedure Pc_AbreTelaPesqNF_Srv;
Var
...
Begin
  ...
  Begin
    ...
    //Se o Arquivo não existir e se o conteudo maior do zero
